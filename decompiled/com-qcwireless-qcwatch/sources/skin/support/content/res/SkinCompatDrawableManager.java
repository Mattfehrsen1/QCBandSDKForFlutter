...
final class SkinCompatDrawableManager {
    ...
    Drawable getDrawable(Context context, int i, boolean z) throws XmlPullParserException, Resources.NotFoundException, IOException {
        ...
        if (drawableLoadDrawableFromDelegates == null) {
            drawableLoadDrawableFromDelegates = SkinCompatResources.getDrawable(context, i);
        }
        if (drawableLoadDrawableFromDelegates != null) {
            drawableLoadDrawableFromDelegates = tintDrawable(context, i, z, drawableLoadDrawableFromDelegates);
        }
        if (drawableLoadDrawableFromDelegates != null) {
            SkinCompatDrawableUtils.fixDrawable(drawableLoadDrawableFromDelegates);
        }
    ...
    private Drawable tintDrawable(Context context, int i, boolean z, Drawable drawable) {
        ...
        if (i == R.drawable.abc_seekbar_track_material) {
            ...
            setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(android.R.id.secondaryProgress), SkinCompatThemeUtils.getThemeAttrColor(context, R.attr.colorControlNormal), mode);
        ...
        if (i == R.drawable.abc_ratingbar_material || i == R.drawable.abc_ratingbar_indicator_material || i == R.drawable.abc_ratingbar_small_material) {
            ...
            setPorterDuffColorFilter(layerDrawable2.findDrawableByLayerId(android.R.id.secondaryProgress), SkinCompatThemeUtils.getThemeAttrColor(context, R.attr.colorControlActivated), mode2);
            setPorterDuffColorFilter(layerDrawable2.findDrawableByLayerId(android.R.id.progress), SkinCompatThemeUtils.getThemeAttrColor(context, R.attr.colorControlActivated), mode2);
            return drawable;
        }
        ...
        if (typedValue.string != null && typedValue.string.toString().endsWith(".xml")) {
            try {
                ...
                if (inflateDelegate != null) {
                    cachedDrawable = inflateDelegate.createFromXmlInner(context, xml, attributeSetAsAttributeSet, null);
                }
                if (cachedDrawable != null) {
                    cachedDrawable.setChangingConfigurations(typedValue.changingConfigurations);
                    addDrawableToCache(context, jCreateCacheKey, cachedDrawable);
