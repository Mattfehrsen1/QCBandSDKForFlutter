...
public final class Utf8 {
    ...
    public static final boolean isUtf8Continuation(byte b) {
        return (b & Mmi.AU_MMI_SD_PLAYBACK_SWITCH) == 128;
    }
    ...
    */
    ...
    public static final int process3Utf8Bytes(byte[] bArr, int i, int i2, Function1<? super Integer, Unit> yield) {
        ...
        if (i2 <= i3) {
            ...
            int i4 = i + 1;
            if (i2 > i4) {
                if ((bArr[i4] & Mmi.AU_MMI_SD_PLAYBACK_SWITCH) == 128) {
                    return 2;
                }
            }
            return 1;
        ...
        byte b3 = bArr[i3];
        if (!((b3 & Mmi.AU_MMI_SD_PLAYBACK_SWITCH) == 128)) {
            yield.invoke(numValueOf);
            return 2;
        }
    ...
    public static final int process4Utf8Bytes(byte[] bArr, int i, int i2, Function1<? super Integer, Unit> yield) {
        ...
        if (i2 <= i3) {
            ...
            if (i2 > i4) {
                if ((bArr[i4] & Mmi.AU_MMI_SD_PLAYBACK_SWITCH) == 128) {
                    int i5 = i + 2;
                    if (i2 > i5) {
                        if ((bArr[i5] & Mmi.AU_MMI_SD_PLAYBACK_SWITCH) == 128) {
                            return 3;
                        }
                    }
                    return 2;
        ...
        byte b4 = bArr[i3];
        if (!((b4 & Mmi.AU_MMI_SD_PLAYBACK_SWITCH) == 128)) {
            yield.invoke(numValueOf);
            return 3;
        }
