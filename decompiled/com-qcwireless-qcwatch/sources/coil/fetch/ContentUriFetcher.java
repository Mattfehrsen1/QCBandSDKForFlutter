...
public final class ContentUriFetcher implements Fetcher {
    ...
    public Object fetch(Continuation<? super FetchResult> continuation) throws FileNotFoundException {
        ...
        if (isContactPhotoUri$coil_base_release(this.data)) {
            ...
            AssetFileDescriptor assetFileDescriptorOpenTypedAssetFile = contentResolver.openTypedAssetFile(this.data, SelectMimeType.SYSTEM_IMAGE, newMusicThumbnailSizeOptions(), null);
    ...
    public final boolean isMusicThumbnailUri$coil_base_release(Uri data) {
        ...
        int size;
        return Intrinsics.areEqual(data.getAuthority(), "media") && (size = (pathSegments = data.getPathSegments()).size()) >= 3 && Intrinsics.areEqual(pathSegments.get(size + (-3)), PictureMimeType.MIME_TYPE_PREFIX_AUDIO) && Intrinsics.areEqual(pathSegments.get(size + (-2)), "albums");
    }
    ...
    private final Bundle newMusicThumbnailSizeOptions() {
        ...
        Integer numValueOf = pixels == null ? null : Integer.valueOf(pixels.px);
        if (numValueOf == null) {
            return null;
        }
        ...
        Integer numValueOf2 = pixels2 == null ? null : Integer.valueOf(pixels2.px);
        if (numValueOf2 == null) {
            return null;
        }
        int iIntValue2 = numValueOf2.intValue();
        Bundle bundle = new Bundle(1);
        bundle.putParcelable("android.content.extra.SIZE", new Point(iIntValue, iIntValue2));
        return bundle;
    }

    /* compiled from: ContentUriFetcher.kt */
    @Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0003J\"\u0010\u0004\u001a\u0004\u0018\u00010\u00052\u0006\u0010\u0006\u001a\u00020\u00022\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0016J\u0010\u0010\u000b\u001a\u00020\f2\u0006\u0010\u0006\u001a\u00020\u0002H\u0002¨\u0006\r"}, d2 = {"Lcoil/fetch/ContentUriFetcher$Factory;", "Lcoil/fetch/Fetcher$Factory;", "Landroid/net/Uri;", "()V", "create", "Lcoil/fetch/Fetcher;", "data", "options", "Lcoil/request/Options;", "imageLoader", "Lcoil/ImageLoader;", "isApplicable", "", "coil-base_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
    public static final class Factory implements Fetcher.Factory<Uri> {
        ...
        private final boolean isApplicable(Uri data) {
            return Intrinsics.areEqual(data.getScheme(), Constant.MODIFY_ACTIVITY_INTENT_CONTENT);
        }
    }
}
