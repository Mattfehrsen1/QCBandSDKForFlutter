...
public final class DefaultRequestOptions {
    ...
    public int hashCode() {
        int iHashCode = ((((((((((((((((this.interceptorDispatcher.hashCode() * 31) + this.fetcherDispatcher.hashCode()) * 31) + this.decoderDispatcher.hashCode()) * 31) + this.transformationDispatcher.hashCode()) * 31) + this.transitionFactory.hashCode()) * 31) + this.precision.hashCode()) * 31) + this.bitmapConfig.hashCode()) * 31) + DecodeResult$$ExternalSyntheticBackport0.m(this.allowHardware)) * 31) + DecodeResult$$ExternalSyntheticBackport0.m(this.allowRgb565)) * 31;
