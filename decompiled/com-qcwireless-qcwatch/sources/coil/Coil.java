...
public final class Coil {
    ...
    private final synchronized ImageLoader newImageLoader(Context context) {
        ...
        ImageLoader imageLoaderNewImageLoader = imageLoaderFactory2 == null ? null : imageLoaderFactory2.newImageLoader();
        if (imageLoaderNewImageLoader == null) {
            ...
            imageLoaderNewImageLoader = imageLoaderFactory3 == null ? null : imageLoaderFactory3.newImageLoader();
            if (imageLoaderNewImageLoader == null) {
                imageLoaderNewImageLoader = ImageLoaders.create(context);
            }
        }
        imageLoaderFactory = null;
