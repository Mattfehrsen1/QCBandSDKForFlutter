...
public final class ComponentRegistry {
    ...
    public final Object map(Object data, Options options) {
        ...
        while (i < size) {
            ...
            if (pair.component2().isAssignableFrom(data.getClass()) && (map = mapperComponent1.map(data, options)) != null) {
                data = map;
            }
            i = i2;
        }
    ...
    public final String key(Object data, Options options) {
        ...
        while (i < size) {
            ...
            if (pair.component2().isAssignableFrom(data.getClass()) && (strKey = keyerComponent1.key(data, options)) != null) {
                return strKey;
            }
            i = i2;
        }
    ...
    public final Pair<Fetcher, Integer> newFetcher(Object data, Options options, ImageLoader imageLoader, int startIndex) {
        ...
        while (startIndex < size) {
            ...
            if (pair.component2().isAssignableFrom(data.getClass()) && (fetcherCreate = factoryComponent1.create(data, options, imageLoader)) != null) {
    ...
    public static final class Builder {
        ...
        public final Builder add(Interceptor interceptor) {
            getInterceptors$coil_base_release().add(interceptor);
            return this;
        }
        ...
        public final <T> Builder add(Mapper<T, ?> mapper, Class<T> type) {
            getMappers$coil_base_release().add(TuplesKt.to(mapper, type));
            return this;
        }
        ...
        public final <T> Builder add(Keyer<T> keyer, Class<T> type) {
            getKeyers$coil_base_release().add(TuplesKt.to(keyer, type));
            return this;
        }
        ...
        public final <T> Builder add(Fetcher.Factory<T> factory, Class<T> type) {
            getFetcherFactories$coil_base_release().add(TuplesKt.to(factory, type));
            return this;
        }

        public final Builder add(Decoder.Factory factory) {
            getDecoderFactories$coil_base_release().add(factory);
            return this;
        }
