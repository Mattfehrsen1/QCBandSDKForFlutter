...
final class AdjustedTimeMark extends TimeMark {
    ...
    public long mo2382elapsedNowUwyO8pc() {
        return Duration.m2424minusLRDsOJo(this.mark.mo2382elapsedNowUwyO8pc(), getAdjustment());
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo2383plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2425plusLRDsOJo(getAdjustment(), duration), null);
    }
}
