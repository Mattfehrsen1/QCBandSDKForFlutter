    ...
    */
    public static final boolean copyRecursively(java.io.File r11, java.io.File r12, boolean r13, final kotlin.jvm.functions.Function2<? super java.io.File, ? super java.io.IOException, ? extends kotlin.io.OnErrorAction> r14) {
        ...
        L2f:
            return r1
        L30:
            kotlin.io.FileTreeWalk r0 = kotlin.io.FilesKt.walkTopDown(r11)     // Catch: kotlin.io.TerminateException -> Le0
            kotlin.io.FilesKt__UtilsKt$copyRecursively$2 r3 = new kotlin.io.FilesKt__UtilsKt$copyRecursively$2     // Catch: kotlin.io.TerminateException -> Le0
            r3.<init>()     // Catch: kotlin.io.TerminateException -> Le0
            kotlin.jvm.functions.Function2 r3 = (kotlin.jvm.functions.Function2) r3     // Catch: kotlin.io.TerminateException -> Le0
            kotlin.io.FileTreeWalk r0 = r0.onFail(r3)     // Catch: kotlin.io.TerminateException -> Le0
            java.util.Iterator r0 = r0.iterator()     // Catch: kotlin.io.TerminateException -> Le0
        L43:
            boolean r3 = r0.hasNext()     // Catch: kotlin.io.TerminateException -> Le0
            if (r3 == 0) goto Ldf
            java.lang.Object r3 = r0.next()     // Catch: kotlin.io.TerminateException -> Le0
            java.io.File r3 = (java.io.File) r3     // Catch: kotlin.io.TerminateException -> Le0
            boolean r4 = r3.exists()     // Catch: kotlin.io.TerminateException -> Le0
            if (r4 != 0) goto L6a
            kotlin.io.NoSuchFileException r10 = new kotlin.io.NoSuchFileException     // Catch: kotlin.io.TerminateException -> Le0
            r6 = 0
            ...
            r4 = r10
            r5 = r3
            r4.<init>(r5, r6, r7, r8, r9)     // Catch: kotlin.io.TerminateException -> Le0
            java.lang.Object r3 = r14.invoke(r3, r10)     // Catch: kotlin.io.TerminateException -> Le0
            kotlin.io.OnErrorAction r4 = kotlin.io.OnErrorAction.TERMINATE     // Catch: kotlin.io.TerminateException -> Le0
            if (r3 != r4) goto L43
            return r2
        L6a:
            java.lang.String r4 = kotlin.io.FilesKt.toRelativeString(r3, r11)     // Catch: kotlin.io.TerminateException -> Le0
            java.io.File r5 = new java.io.File     // Catch: kotlin.io.TerminateException -> Le0
            r5.<init>(r12, r4)     // Catch: kotlin.io.TerminateException -> Le0
            boolean r4 = r5.exists()     // Catch: kotlin.io.TerminateException -> Le0
            if (r4 == 0) goto Lb0
            boolean r4 = r3.isDirectory()     // Catch: kotlin.io.TerminateException -> Le0
            if (r4 == 0) goto L85
            boolean r4 = r5.isDirectory()     // Catch: kotlin.io.TerminateException -> Le0
            if (r4 != 0) goto Lb0
        L85:
            if (r13 != 0) goto L89
        L87:
        ...
        L89:
            boolean r4 = r5.isDirectory()     // Catch: kotlin.io.TerminateException -> Le0
            if (r4 == 0) goto L96
            boolean r4 = kotlin.io.FilesKt.deleteRecursively(r5)     // Catch: kotlin.io.TerminateException -> Le0
            if (r4 != 0) goto L9d
            goto L87
        L96:
            boolean r4 = r5.delete()     // Catch: kotlin.io.TerminateException -> Le0
            if (r4 != 0) goto L9d
            goto L87
        L9d:
            r4 = 0
        L9e:
            if (r4 == 0) goto Lb0
            kotlin.io.FileAlreadyExistsException r4 = new kotlin.io.FileAlreadyExistsException     // Catch: kotlin.io.TerminateException -> Le0
            java.lang.String r6 = "The destination file already exists."
            r4.<init>(r3, r5, r6)     // Catch: kotlin.io.TerminateException -> Le0
            java.lang.Object r3 = r14.invoke(r5, r4)     // Catch: kotlin.io.TerminateException -> Le0
            kotlin.io.OnErrorAction r4 = kotlin.io.OnErrorAction.TERMINATE     // Catch: kotlin.io.TerminateException -> Le0
            if (r3 != r4) goto L43
            return r2
        Lb0:
            boolean r4 = r3.isDirectory()     // Catch: kotlin.io.TerminateException -> Le0
            if (r4 == 0) goto Lba
            r5.mkdirs()     // Catch: kotlin.io.TerminateException -> Le0
            goto L43
        Lba:
            r7 = 0
            r8 = 4
            ...
            r4 = r3
            r6 = r13
            java.io.File r4 = kotlin.io.FilesKt.copyTo$default(r4, r5, r6, r7, r8, r9)     // Catch: kotlin.io.TerminateException -> Le0
            long r4 = r4.length()     // Catch: kotlin.io.TerminateException -> Le0
            long r6 = r3.length()     // Catch: kotlin.io.TerminateException -> Le0
            int r8 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            if (r8 == 0) goto L43
            java.io.IOException r4 = new java.io.IOException     // Catch: kotlin.io.TerminateException -> Le0
            java.lang.String r5 = "Source file wasn't copied completely, length of destination file differs."
            r4.<init>(r5)     // Catch: kotlin.io.TerminateException -> Le0
            java.lang.Object r3 = r14.invoke(r3, r4)     // Catch: kotlin.io.TerminateException -> Le0
            kotlin.io.OnErrorAction r4 = kotlin.io.OnErrorAction.TERMINATE     // Catch: kotlin.io.TerminateException -> Le0
            if (r3 != r4) goto L43
            return r2
        Ldf:
