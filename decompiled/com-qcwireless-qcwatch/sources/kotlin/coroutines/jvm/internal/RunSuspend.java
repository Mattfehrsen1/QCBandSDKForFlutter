...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m2292getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result) {
        synchronized (this) {
            this.result = Result.m1104boximpl(result);
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> resultM2292getResultxLWZpok = m2292getResultxLWZpok();
                if (resultM2292getResultxLWZpok == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(resultM2292getResultxLWZpok.getValue());
                }
            }
        }
    }
