...
public class WindowInsetsCompat {
    ...
    private static class Impl20 extends Impl {
        ...
        protected Insets getInsetsForType(int i, boolean z) {
            ...
            if (i == 1) {
                if (z) {
                    return Insets.of(0, Math.max(getRootStableInsets().f21top, getSystemWindowInsets().f21top), 0, 0);
                }
                return Insets.of(0, getSystemWindowInsets().f21top, 0, 0);
            }
            if (i == 2) {
                if (z) {
    ...
    static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        int iMax2 = Math.max(0, insets.f21top - i2);
