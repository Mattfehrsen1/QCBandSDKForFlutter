...
class FontProvider {
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        Uri uriBuild = new Uri.Builder().scheme(Constant.MODIFY_ACTIVITY_INTENT_CONTENT).authority(str).build();
        Uri uriBuild2 = new Uri.Builder().scheme(Constant.MODIFY_ACTIVITY_INTENT_CONTENT).authority(str).appendPath("file").build();
