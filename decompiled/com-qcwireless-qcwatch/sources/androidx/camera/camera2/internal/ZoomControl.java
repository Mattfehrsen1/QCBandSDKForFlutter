...
final class ZoomControl {
    ...
    interface ZoomImpl {
        ...
        void onCaptureResult(TotalCaptureResult captureResult);

        void resetZoom();

        void setZoomRatio(float zoomRatio, CallbackToFutureAdapter.Completer<Void> completer);
    }

    ZoomControl(Camera2CameraControlImpl camera2CameraControlImpl, CameraCharacteristicsCompat cameraCharacteristics, Executor executor) throws IllegalArgumentException {
        this.mCamera2CameraControlImpl = camera2CameraControlImpl;
        this.mExecutor = executor;
        ZoomImpl zoomImplCreateZoomImpl = createZoomImpl(cameraCharacteristics);
    ...
    static ZoomState getDefaultZoomState(CameraCharacteristicsCompat cameraCharacteristics) throws IllegalArgumentException {
        ZoomImpl zoomImplCreateZoomImpl = createZoomImpl(cameraCharacteristics);
        ZoomStateImpl zoomStateImpl = new ZoomStateImpl(zoomImplCreateZoomImpl.getMaxZoom(), zoomImplCreateZoomImpl.getMinZoom());
        zoomStateImpl.setZoomRatio(1.0f);
    ...
    private static boolean isAndroidRZoomSupported(CameraCharacteristicsCompat cameraCharacteristics) {
        return Build.VERSION.SDK_INT >= 30 && cameraCharacteristics.get(CameraCharacteristics.CONTROL_ZOOM_RATIO_RANGE) != null;
    }
    ...
    ListenableFuture<Void> setZoomRatio(float ratio) {
        ...
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.ZoomControl$$ExternalSyntheticLambda1
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m53xc6d8bfa2(zoomStateCreate, completer);
            }
        });
    }

    /* renamed from: lambda$setZoomRatio$1$androidx-camera-camera2-internal-ZoomControl, reason: not valid java name */
    public /* synthetic */ Object m53xc6d8bfa2(final ZoomState zoomState, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.ZoomControl$$ExternalSyntheticLambda3
            ...
            public final void run() {
                this.f$0.m52xd613203(completer, zoomState);
            }
        });
        return "setZoomRatio";
    }
    ...
    public void m52xd613203(CallbackToFutureAdapter.Completer<Void> completer, ZoomState zoomState) {
        ZoomState zoomStateCreate;
        if (!this.mIsActive) {
            synchronized (this.mCurrentZoomState) {
                this.mCurrentZoomState.setZoomRatio(1.0f);
    ...
    ListenableFuture<Void> setLinearZoom(float linearZoom) {
        ...
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.ZoomControl$$ExternalSyntheticLambda0
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m51x9f268096(zoomStateCreate, completer);
            }
        });
    }

    /* renamed from: lambda$setLinearZoom$3$androidx-camera-camera2-internal-ZoomControl, reason: not valid java name */
    public /* synthetic */ Object m51x9f268096(final ZoomState zoomState, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.ZoomControl$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m50xe5aef2f7(completer, zoomState);
            }
        });
