...
public class TargetAspectRatio {
    ...
    public int get(ImageOutputConfig imageOutputConfig, String cameraId, CameraCharacteristicsCompat cameraCharacteristicsCompat) {
        ...
        AspectRatioLegacyApi21Quirk aspectRatioLegacyApi21Quirk = (AspectRatioLegacyApi21Quirk) CameraQuirks.get(cameraId, cameraCharacteristicsCompat).get(AspectRatioLegacyApi21Quirk.class);
