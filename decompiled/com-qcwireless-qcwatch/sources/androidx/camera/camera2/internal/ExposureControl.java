...
public class ExposureControl {
    ...
    void setCaptureRequestOption(Camera2ImplConfig.Builder configBuilder) {
    ...
    ListenableFuture<Integer> setExposureCompensationIndex(final int exposure) {
        ...
        if (!exposureCompensationRange.contains((Range<Integer>) Integer.valueOf(exposure))) {
            return Futures.immediateFailedFuture(new IllegalArgumentException("Requested ExposureCompensation " + exposure + " is not within valid range [" + exposureCompensationRange.getUpper() + ".." + exposureCompensationRange.getLower() + "]"));
        }
        ...
        return Futures.nonCancellationPropagating(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.ExposureControl$$ExternalSyntheticLambda1
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m31x8eaf9914(exposure, completer);
            }
        }));
    }
    ...
    public /* synthetic */ Object m31x8eaf9914(final int i, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.ExposureControl$$ExternalSyntheticLambda2
            ...
            public final void run() {
                this.f$0.m30x9d05f2f5(completer, i);
            }
        });
    ...
    public /* synthetic */ void m30x9d05f2f5(final CallbackToFutureAdapter.Completer completer, final int i) {
        if (!this.mIsActive) {
            this.mExposureStateImpl.setExposureCompensationIndex(0);
