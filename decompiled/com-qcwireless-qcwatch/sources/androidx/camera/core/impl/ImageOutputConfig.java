...
public interface ImageOutputConfig extends ReadableConfig {
    ...
    public interface Builder<B> {
        B setDefaultResolution(Size resolution);

        B setMaxResolution(Size resolution);

        B setSupportedResolutions(List<Pair<Integer, Size[]>> resolutionsList);
    ...
    Size getDefaultResolution(Size valueIfMissing);
    ...
    List<Pair<Integer, Size[]>> getSupportedResolutions(List<Pair<Integer, Size[]>> valueIfMissing);
    ...
    public final /* synthetic */ class CC {
        public static Size $default$getTargetResolution(ImageOutputConfig _this, Size valueIfMissing) {
        ...
        public static Size $default$getDefaultResolution(ImageOutputConfig _this, Size valueIfMissing) {
        ...
        public static Size $default$getMaxResolution(ImageOutputConfig _this, Size valueIfMissing) {
        ...
        public static List $default$getSupportedResolutions(ImageOutputConfig _this, List valueIfMissing) {
