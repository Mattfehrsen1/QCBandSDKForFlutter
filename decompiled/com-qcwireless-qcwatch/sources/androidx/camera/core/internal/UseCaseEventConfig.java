...
public interface UseCaseEventConfig extends ReadableConfig {
    ...
    UseCase.EventCallback getUseCaseEventCallback(UseCase.EventCallback valueIfMissing);

    /* renamed from: androidx.camera.core.internal.UseCaseEventConfig$-CC, reason: invalid class name */
    public final /* synthetic */ class CC {
        public static UseCase.EventCallback $default$getUseCaseEventCallback(UseCaseEventConfig _this, UseCase.EventCallback valueIfMissing) {
