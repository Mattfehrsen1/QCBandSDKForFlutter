...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo177clone = transition.mo177clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo177clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo177clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo177clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo177clone = transition.mo177clone();
        sceneChangeSetup(viewGroup, transitionMo177clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo177clone);
    }
