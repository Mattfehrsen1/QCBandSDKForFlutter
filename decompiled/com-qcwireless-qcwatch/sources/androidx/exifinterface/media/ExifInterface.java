...
public class ExifInterface {
    ...
    private static final byte[] HEIF_TYPE_FTYP = {Mmi.AU_MMI_SWITCH_NEXT_VOICE_PROMPT_LANGUAGE, 116, Mmi.AU_MMI_RWS_SYNC_RINGTONE, 112};
    private static final byte[] HEIF_BRAND_MIF1 = {109, 105, Mmi.AU_MMI_SWITCH_NEXT_VOICE_PROMPT_LANGUAGE, 49};
    private static final byte[] HEIF_BRAND_HEIC = {Mmi.AU_MMI_OUTPUT_INDICATION_2, Mmi.AU_MMI_AUDIO_PASS_THROUGH, 105, Mmi.AU_MMI_AUDIO_EFFECT_NEXT};
    private static final byte[] ORF_MAKER_NOTE_HEADER_1 = {79, LargeDataHandler.ACTION_SMS_QUICK, Mmi.AU_MMI_DEV_DISCONNECT_ALL_LINK, 77, 80, 0};
    private static final byte[] ORF_MAKER_NOTE_HEADER_2 = {79, LargeDataHandler.ACTION_SMS_QUICK, Mmi.AU_MMI_DEV_DISCONNECT_ALL_LINK, 77, 80, Mmi.AU_MMI_DEV_POWER_ON_BUTTON_RELEASE, Mmi.AU_MMI_DEV_LINK_LAST_DEVICE, 0, 73, 73};
    private static final byte[] PNG_SIGNATURE = {Mmi.AU_MMI_AUDIO_DUAL_EFFECT_SWITCH, 80, 78, LargeDataHandler.ACTION_Blood_Sugar, 13, 10, Constants.CMD_SEND_WEATHER_FORECAST, 10};
    private static final byte[] PNG_CHUNK_TYPE_EXIF = {Mmi.AU_MMI_AUDIO_PASS_THROUGH, Mmi.AU_MMI_DEV_FACTORY_RESET_TO_DEFAULT, 73, Mmi.AU_MMI_SWITCH_NEXT_VOICE_PROMPT_LANGUAGE};
    private static final byte[] PNG_CHUNK_TYPE_IHDR = {73, 72, Constants.CMD_GET_SLEEP, 82};
    private static final byte[] PNG_CHUNK_TYPE_IEND = {73, 69, 78, Constants.CMD_GET_SLEEP};
    private static final byte[] WEBP_SIGNATURE_1 = {82, 73, Constants.CMD_QUERY_DATA_DISTRIBUTION, Constants.CMD_QUERY_DATA_DISTRIBUTION};
    private static final byte[] WEBP_SIGNATURE_2 = {Mmi.AU_MMI_DEV_POWER_OFF_BUTTON_RELEASE, 69, 66, 80};
    private static final byte[] WEBP_CHUNK_TYPE_EXIF = {69, Mmi.AU_MMI_DEV_FACTORY_RESET_TO_DEFAULT, 73, Constants.CMD_QUERY_DATA_DISTRIBUTION};
    ...
    static final byte[] EXIF_ASCII_PREFIX = {65, Mmi.AU_MMI_DEV_LINK_LAST_DEVICE, Constants.CMD_GET_STEP_SOMEDAY_DETAIL, 73, 73, 0, 0, 0};
    ...
    static {
        ...
        ExifTag[] exifTagArr7 = {new ExifTag(TAG_ORF_PREVIEW_IMAGE_START, 257, 4), new ExifTag(TAG_ORF_PREVIEW_IMAGE_LENGTH, Contract.CMD_SET_VERSION.V1_2, 4)};
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B