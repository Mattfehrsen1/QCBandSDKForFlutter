    ...
    */
    ...
    private static Configuration generateConfigDelta(Configuration configuration, Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            if ((configuration.screenLayout & BluetoothSpp.STATE_DISCONNECTING) != (configuration2.screenLayout & BluetoothSpp.STATE_DISCONNECTING)) {
                configuration3.screenLayout |= configuration2.screenLayout & BluetoothSpp.STATE_DISCONNECTING;
            }
            if (Build.VERSION.SDK_INT >= 26) {
