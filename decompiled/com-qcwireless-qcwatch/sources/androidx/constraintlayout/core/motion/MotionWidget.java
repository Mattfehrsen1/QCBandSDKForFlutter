...
public class MotionWidget implements TypedValues {
    ...
    public String toString() {
        return this.widgetFrame.left + ", " + this.widgetFrame.f16top + ", " + this.widgetFrame.right + ", " + this.widgetFrame.bottom;
    }
    ...
    public int getTop() {
        return this.widgetFrame.f16top;
    }
    ...
    public int getHeight() {
        return this.widgetFrame.bottom - this.widgetFrame.f16top;
    }
