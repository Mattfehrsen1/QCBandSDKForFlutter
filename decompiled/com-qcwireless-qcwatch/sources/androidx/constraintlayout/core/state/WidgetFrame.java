...
public class WidgetFrame {
    ...
    public int height() {
        return Math.max(0, this.bottom - this.f16top);
    }
    ...
    public WidgetFrame(WidgetFrame widgetFrame) {
        ...
        this.f16top = widgetFrame.f16top;
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        int i12 = widgetFrame2.f16top;
        int i13 = widgetFrame3.left;
        int i14 = widgetFrame3.f16top;
    ...
    public float centerY() {
        return this.f16top + ((this.bottom - r0) / 2.0f);
    }
    ...
    public WidgetFrame update() {
        ...
        if (constraintWidget != null) {
            ...
            this.f16top = this.widget.getTop();
