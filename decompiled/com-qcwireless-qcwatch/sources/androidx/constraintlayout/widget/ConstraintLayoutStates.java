    ...
    */
    private void load(android.content.Context r9, int r10) throws org.xmlpull.v1.XmlPullParserException, android.content.res.Resources.NotFoundException, java.io.IOException, java.lang.NumberFormatException {
        /*
            ...
            r0 = 0
            int r1 = r10.getEventType()     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
        Ld:
            r2 = 1
            if (r1 == r2) goto L8d
            if (r1 == 0) goto L7c
            ...
            goto L7f
        L17:
            java.lang.String r1 = r10.getName()     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
            r4 = -1
            int r5 = r1.hashCode()     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
            r6 = 4
            r7 = 3
            switch(r5) {
                ...
                default: goto L25;
            }     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
        L25:
            goto L58
        L26:
            java.lang.String r2 = "Variant"
            boolean r1 = r1.equals(r2)     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
            if (r1 == 0) goto L58
            r2 = 3
            goto L59
        L30:
        ...
        L3b:
            ...
            boolean r1 = r1.equals(r5)     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
            if (r1 == 0) goto L58
            goto L59
        L44:
        ...
        L59:
            ...
            goto L7f
        L60:
            r8.parseConstraintSet(r9, r10)     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
            goto L7f
        L64:
            androidx.constraintlayout.widget.ConstraintLayoutStates$Variant r1 = new androidx.constraintlayout.widget.ConstraintLayoutStates$Variant     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
            r1.<init>(r9, r10)     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
            if (r0 == 0) goto L7f
            r0.add(r1)     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
            goto L7f
        L6f:
            androidx.constraintlayout.widget.ConstraintLayoutStates$State r0 = new androidx.constraintlayout.widget.ConstraintLayoutStates$State     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
            r0.<init>(r9, r10)     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
            android.util.SparseArray<androidx.constraintlayout.widget.ConstraintLayoutStates$State> r1 = r8.mStateList     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
            int r2 = r0.mId     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
            r1.put(r2, r0)     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
            goto L7f
        L7c:
            r10.getName()     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
        L7f:
            int r1 = r10.next()     // Catch: java.io.IOException -> L84 org.xmlpull.v1.XmlPullParserException -> L89
            goto Ld
        L84:
            r9 = move-exception
            r9.printStackTrace()
    ...
    private void parseConstraintSet(Context context, XmlPullParser parser) throws NumberFormatException {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (attributeName != null && attributeValue != null && BreakpointSQLiteKey.ID.equals(attributeName)) {
                int identifier = attributeValue.contains("/") ? context.getResources().getIdentifier(attributeValue.substring(attributeValue.indexOf(47) + 1), BreakpointSQLiteKey.ID, context.getPackageName()) : -1;
                if (identifier == -1) {
