...
public abstract class ConstraintHelper extends View {
    ...
    public ConstraintHelper(Context context, AttributeSet attrs, int defStyleAttr) throws IllegalAccessException, Resources.NotFoundException, IllegalArgumentException {
    ...
    private int findId(String referenceId) throws IllegalAccessException, Resources.NotFoundException, IllegalArgumentException {
        ...
        return iFindId == 0 ? this.myContext.getResources().getIdentifier(referenceId, BreakpointSQLiteKey.ID, this.myContext.getPackageName()) : iFindId;
    }
