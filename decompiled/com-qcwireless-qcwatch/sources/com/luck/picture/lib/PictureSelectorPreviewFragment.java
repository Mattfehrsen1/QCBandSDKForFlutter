...
public class PictureSelectorPreviewFragment extends PictureCommonFragment {
    ...
    public void changeViewParams(int[] iArr) {
        ...
        if (itemViewParams == null || iArr[0] == 0 || iArr[1] == 0) {
            ...
            this.magicalView.setViewParams(itemViewParams.left, itemViewParams.f42top, itemViewParams.width, itemViewParams.height, iArr[0], iArr[1]);
    ...
    public void setMagicalViewParams(int i, int i2, int i3) {
        ...
        if (itemViewParams == null || i == 0 || i2 == 0) {
            ...
            this.magicalView.setViewParams(itemViewParams.left, itemViewParams.f42top, itemViewParams.width, itemViewParams.height, i, i2);
        }
    }
