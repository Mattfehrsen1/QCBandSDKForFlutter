...
public final class Detector {
    ...
    public static PDF417DetectorResult detect(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map, boolean z) throws NotFoundException {
        ...
        if (listDetect.isEmpty()) {
            blackMatrix = blackMatrix.m226clone();
    ...
    private static ResultPoint[] findRowsWithPattern(BitMatrix bitMatrix, int i, int i2, int i3, int i4, int[] iArr) {
        ...
        while (true) {
            ...
            if (iArrFindGuardPattern != null) {
                ...
                while (true) {
                    ...
                    int i11 = i10 - 1;
                    int[] iArrFindGuardPattern2 = findGuardPattern(bitMatrix, i4, i11, i2, false, iArr, iArr2);
        ...
        if (z) {
            ...
            while (true) {
                ...
                i5 = i14;
                i6 = i13;
                int[] iArrFindGuardPattern3 = findGuardPattern(bitMatrix, iArr4[0], i13, i2, false, iArr, iArr2);
