...
final class PDF417HighLevelEncoder {
    ...
    private static final byte[] TEXT_MIXED_RAW = {48, 49, 50, 51, Mmi.AU_MMAU_MMI_AV_FWD, Mmi.AU_MMI_AV_BWD, 54, 55, 56, 57, Constants.CMD_GET_SIT_LONG, 13, 9, 44, 58, Constants.CMD_SET_ALARM_CLOCK, 45, LargeDataHandler.ACTION_BT_MAC_Protocol, Constants.CMD_GET_ALARM_CLOCK, 47, Constants.CMD_MENSTRUATION, Constants.CMD_SET_SIT_LONG, 42, 61, 94, 0, 32, 0, 0, 0};
    private static final byte[] TEXT_PUNCTUATION_RAW = {Mmi.AU_MMI_AV_FASTFORWARD_RELEASE, 60, 62, 64, Mmi.AU_MMI_DEV_RWS_FACTORY_BY_SPP, Mmi.AU_MMI_ENTER_DUT_FROM_SPP, 93, 95, 96, Mmi.AU_MMI_RWS_SYNC_LK_SEC, 33, 13, 9, 44, 58, 10, 45, LargeDataHandler.ACTION_BT_MAC_Protocol, Constants.CMD_GET_ALARM_CLOCK, 47, Constants.CMD_FIND_THE_PHONE, Mmi.AU_MMI_RWS_LOAD_CFG, 42, 40, 41, 63, Mmi.AU_MMI_RWS_SAVE_CFG, Mmi.AU_MMI_RWS_SYNC_LK_PRI, 39, 0};
