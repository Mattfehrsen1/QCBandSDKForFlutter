...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{529}, "CY");
            add(new int[]{531}, "MK");
            add(new int[]{GattClient.STATE_PREPARE_CONNECTING}, "MT");
            add(new int[]{GattClient.STATE_READ_DEVICE_INFO}, "IE");
            add(new int[]{GattClient.STATE_READ_PROTOCOL_TYPE, 549}, "BE/LU");
            add(new int[]{560}, "PT");
            add(new int[]{569}, "IS");
            ...
            add(new int[]{880}, "KR");
            add(new int[]{885}, "TH");
            add(new int[]{HealthyViewModel.Type_Sync_TimeOut}, "SG");
            add(new int[]{890}, "IN");
            add(new int[]{893}, "VN");
            add(new int[]{896}, "PK");
            add(new int[]{899}, "ID");
