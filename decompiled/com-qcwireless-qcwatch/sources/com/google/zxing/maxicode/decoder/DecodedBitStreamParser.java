...
final class DecodedBitStreamParser {
    ...
    private static int getCountry(byte[] bArr) {
        return getInt(bArr, new byte[]{Mmi.AU_MMI_AV_BWD, 54, Constants.CMD_MENSTRUATION, 44, 45, LargeDataHandler.ACTION_BT_MAC_Protocol, 47, 48, Constants.CMD_SET_SIT_LONG, Constants.CMD_GET_SIT_LONG});
    }

    private static int getServiceClass(byte[] bArr) {
        return getInt(bArr, new byte[]{55, 56, 57, 58, Mmi.AU_MMI_AV_FASTFORWARD_RELEASE, 60, 49, 50, 51, Mmi.AU_MMAU_MMI_AV_FWD});
    }

    private static int getPostCode2Length(byte[] bArr) {
        return getInt(bArr, new byte[]{39, 40, 41, 42, Constants.CMD_DISPLAY_TIME, 32});
    }

    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, Constants.CMD_FIND_THE_PHONE, Constants.CMD_SET_ALARM_CLOCK, Constants.CMD_GET_ALARM_CLOCK, Constants.CMD_GET_DEGREE_SWITCH, Constants.CMD_SEND_WEATHER_FORECAST, Constants.CMD_GET_BRIGHTNESS, Constants.CMD_GET_MUSIC_SWITCH, Constants.CMD_MUSIC_COMMAND, Constants.CMD_REAL_TIME_HEART_RATE, 19, 20, 21, 22, Constants.CMD_GET_PERSONALIZATION_SETTING, 24, 13, 14, 15, 16, 17, 18, 7, 8, 9, 10, 11, 12, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        String[] strArr = SETS;
        return String.valueOf(new char[]{strArr[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, Constants.CMD_DISPLAY_TIME, 32})), strArr[0].charAt(getInt(bArr, new byte[]{33, Constants.CMD_FIND_THE_PHONE, Constants.CMD_SET_ALARM_CLOCK, Constants.CMD_GET_ALARM_CLOCK, Constants.CMD_GET_DEGREE_SWITCH, Constants.CMD_SEND_WEATHER_FORECAST})), strArr[0].charAt(getInt(bArr, new byte[]{Constants.CMD_GET_BRIGHTNESS, Constants.CMD_GET_MUSIC_SWITCH, Constants.CMD_MUSIC_COMMAND, Constants.CMD_REAL_TIME_HEART_RATE, 19, 20})), strArr[0].charAt(getInt(bArr, new byte[]{21, 22, Constants.CMD_GET_PERSONALIZATION_SETTING, 24, 13, 14})), strArr[0].charAt(getInt(bArr, new byte[]{15, 16, 17, 18, 7, 8})), strArr[0].charAt(getInt(bArr, new byte[]{9, 10, 11, 12, 1, 2}))});
    }
