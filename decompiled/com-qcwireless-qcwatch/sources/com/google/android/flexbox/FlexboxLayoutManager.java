...
public class FlexboxLayoutManager extends RecyclerView.LayoutManager implements FlexContainer, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fixLayoutStartGap(int startOffset, RecyclerView.Recycler recycler, RecyclerView.State state, boolean canOffsetChildren) throws NoSuchFieldException {
    ...
    private int fixLayoutEndGap(int endOffset, RecyclerView.Recycler recycler, RecyclerView.State state, boolean canOffsetChildren) throws NoSuchFieldException {
        int iHandleScrollingMainOrientation;
        int endAfterPadding;
        if (!isMainAxisDirectionHorizontal() && this.mIsRtl) {
    ...
    private void updateFlexLines(int childCount) throws NoSuchFieldException {
        boolean z;
        int i;
    ...
    */
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.LayoutManager
    public int scrollHorizontallyBy(int dx, RecyclerView.Recycler recycler, RecyclerView.State state) throws NoSuchFieldException {
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.LayoutManager
    public int scrollVerticallyBy(int dy, RecyclerView.Recycler recycler, RecyclerView.State state) throws NoSuchFieldException {
    ...
    private int handleScrollingMainOrientation(int delta, RecyclerView.Recycler recycler, RecyclerView.State state) throws NoSuchFieldException {
    ...
    private void updateLayoutState(int layoutDirection, int absDelta) throws NoSuchFieldException {
