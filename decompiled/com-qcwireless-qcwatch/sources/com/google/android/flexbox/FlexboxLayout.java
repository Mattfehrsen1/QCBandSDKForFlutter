...
public class FlexboxLayout extends ViewGroup implements FlexContainer {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) throws NoSuchFieldException {
    ...
    private void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) throws NoSuchFieldException {
    ...
    private void measureVertical(int widthMeasureSpec, int heightMeasureSpec) throws NoSuchFieldException {
        this.mFlexLines.clear();
        this.mFlexLinesResult.reset();
    ...
    protected void onLayout(boolean changed, int left, int top2, int right, int bottom) {
        ...
        if (i == 2) {
            z = layoutDirection == 1;
            layoutVertical(this.mFlexWrap == 2 ? !z : z, false, left, top2, right, bottom);
        } else if (i == 3) {
            z = layoutDirection == 1;
            layoutVertical(this.mFlexWrap == 2 ? !z : z, true, left, top2, right, bottom);
        } else {
    ...
    */
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            for (int i4 = 0; i4 < flexLine.mItemCount; i4++) {
                ...
                if (reorderedChildAt != null && reorderedChildAt.getVisibility() != 8) {
                    ...
                    if (hasDividerBeforeChildAtAlongMainAxis(i5, i4)) {
                        if (fromBottomToTop) {
                            top2 = reorderedChildAt.getBottom() + layoutParams.bottomMargin;
                        } else {
                            top2 = (reorderedChildAt.getTop() - layoutParams.topMargin) - this.mDividerHorizontalHeight;
                        }
    ...
    public int getDecorationLengthMainAxis(View view, int index, int indexInFlexLine) {
        ...
        int i2;
        if (isMainAxisDirectionHorizontal()) {
            i = hasDividerBeforeChildAtAlongMainAxis(index, indexInFlexLine) ? 0 + this.mDividerVerticalWidth : 0;
            if ((this.mShowDividerVertical & 4) <= 0) {
                return i;
            }
            i2 = this.mDividerVerticalWidth;
        } else {
            i = hasDividerBeforeChildAtAlongMainAxis(index, indexInFlexLine) ? 0 + this.mDividerHorizontalHeight : 0;
