...
public class GoogleSignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public int hashCode() {
        return ((this.zak.hashCode() + GattClient.STATE_PREPARED) * 31) + getRequestedScopes().hashCode();
    }
    ...
    public final String zad() throws JSONException {
        ...
        try {
            if (getId() != null) {
                jSONObject.put(BreakpointSQLiteKey.ID, getId());
            }
            if (getIdToken() != null) {
