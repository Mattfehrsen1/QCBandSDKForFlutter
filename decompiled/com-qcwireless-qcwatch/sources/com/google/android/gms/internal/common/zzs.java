...
public final class zzs {
    public static int zza(int i, int i2, String str) {
        ...
        if (i < 0) {
            strZza = zzy.zza("%s (%s) must not be negative", Constant.MODIFY_ACTIVITY_INTENT_INDEX, Integer.valueOf(i));
        } else {
            if (i2 < 0) {
            ...
            strZza = zzy.zza("%s (%s) must be less than size (%s)", Constant.MODIFY_ACTIVITY_INTENT_INDEX, Integer.valueOf(i), Integer.valueOf(i2));
        }
