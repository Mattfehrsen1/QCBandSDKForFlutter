...
public final class zzds implements HistoryApi {
    private final PendingResult zza(GoogleApiClient googleApiClient, DataType dataType, boolean z) {
        return googleApiClient.enqueue(new zzdp(this, googleApiClient, dataType, z));
    }
