...
public final class zzbe extends GmsClient {
    ...
    public final void zzt(CurrentLocationRequest currentLocationRequest, CancellationToken cancellationToken, zzao zzaoVar) throws RemoteException {
        if (zzG(com.google.android.gms.location.zzy.zze)) {
            final ICancelToken iCancelTokenZze = ((zzam) getService()).zze(currentLocationRequest, zzaoVar);
        ...
        ListenerHolder listenerHolderCreateListenerHolder = ListenerHolders.createListenerHolder(new zzau(this, zzaoVar, onTokenCanceledListener), zzbn.zza(Looper.getMainLooper()), "LocationCallback");
        atomicReference.set(listenerHolderCreateListenerHolder);
        if (cancellationToken != null) {
        ...
        locationRequestCreate.setPriority(currentLocationRequest.getPriority());
        locationRequestCreate.setInterval(0L);
        locationRequestCreate.setFastestInterval(0L);
        locationRequestCreate.setExpirationDuration(currentLocationRequest.getDurationMillis());
        zzbf zzbfVarZzc = zzbf.zzc(null, locationRequestCreate);
        zzbfVarZzc.zzj = true;
        zzbfVarZzc.zze(currentLocationRequest.getMaxUpdateAgeMillis());
        zzB(zzbfVarZzc, listenerHolderCreateListenerHolder, new zzav(this, zzaoVar));
    }
