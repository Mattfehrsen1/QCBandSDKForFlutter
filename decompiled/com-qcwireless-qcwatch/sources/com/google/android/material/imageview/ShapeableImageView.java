...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    ...
    public ShapeableImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.strokeColor = MaterialResources.getColorStateList(context2, context2.obtainStyledAttributes(attributeSet, R.styleable.ShapeableImageView, i, i2), R.styleable.ShapeableImageView_strokeColor);
        this.strokeWidth = r1.getDimensionPixelSize(R.styleable.ShapeableImageView_strokeWidth, 0);
