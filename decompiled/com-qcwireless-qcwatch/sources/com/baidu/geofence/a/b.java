...
public class b extends com.baidu.location.h.h implements LBSAuthManagerListener {
    private String b;
    private String c;
    ...
    public void b() {
        ...
        this.ee = "https://api.map.baidu.com/sdkproxy/v2/lbs_locsdk/geocoding/v3/?" + stringBuffer.toString();
    }
        ...
        if (str != null) {
            try {
                ...
                if (jSONObject.has("token")) {
                    ...
                    if (s.b() || TextUtils.isEmpty(this.b)) {
                        return;
                    }
                    a();
                }
