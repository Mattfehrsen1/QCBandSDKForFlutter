...
public final class LteCellValue extends MessageMicro {
    ...
    public int getSerializedSize() {
        int iComputeInt32Size = hasCi() ? 0 + CodedOutputStreamMicro.computeInt32Size(1, getCi()) : 0;
        if (hasPci()) {
            iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(2, getPci());
        }
        if (hasTac()) {
            iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(3, getTac());
        }
        if (hasEarfcn()) {
            iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(4, getEarfcn());
        }
        if (hasBandwidth()) {
            iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(5, getBandwidth());
        }
        if (hasRssi()) {
            iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(6, getRssi());
        }
        if (hasRsrp()) {
            iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(7, getRsrp());
        }
        if (hasRsrq()) {
            iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(8, getRsrq());
        }
        if (hasRssnr()) {
            iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(9, getRssnr());
        }
        if (hasCqi()) {
            iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(10, getCqi());
        }
        if (hasTimingadvance()) {
            iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(11, getTimingadvance());
        }
