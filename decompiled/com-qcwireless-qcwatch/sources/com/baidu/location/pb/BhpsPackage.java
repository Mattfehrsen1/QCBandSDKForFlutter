...
public final class BhpsPackage extends MessageMicro {
    ...
    public int getSerializedSize() {
        ...
        int iComputeUInt32Size = hasGpsPointNum() ? CodedOutputStreamMicro.computeUInt32Size(1, getGpsPointNum()) + 0 : 0;
        if (hasVersion()) {
            iComputeUInt32Size += CodedOutputStreamMicro.computeStringSize(2, getVersion());
        }
        if (hasCuid()) {
            iComputeUInt32Size += CodedOutputStreamMicro.computeBytesSize(3, getCuid());
        }
        if (hasGpsFirst()) {
            iComputeUInt32Size += CodedOutputStreamMicro.computeMessageSize(4, getGpsFirst());
        }
        Iterator<BhpsPointDelta> it = getGpsPointDelatList().iterator();
        while (it.hasNext()) {
            iComputeUInt32Size += CodedOutputStreamMicro.computeMessageSize(7, it.next());
        }
        if (hasFrom()) {
            iComputeUInt32Size += CodedOutputStreamMicro.computeUInt32Size(8, getFrom());
        }
        if (hasSubFrom()) {
            iComputeUInt32Size += CodedOutputStreamMicro.computeStringSize(9, getSubFrom());
        }
        if (hasNaviStartOrEndFlag()) {
            iComputeUInt32Size += CodedOutputStreamMicro.computeUInt32Size(10, getNaviStartOrEndFlag());
        }
        if (hasEventBrand()) {
            iComputeUInt32Size += CodedOutputStreamMicro.computeUInt32Size(11, getEventBrand());
        }
        if (hasRtkSdkVersion()) {
            iComputeUInt32Size += CodedOutputStreamMicro.computeStringSize(12, getRtkSdkVersion());
        }
        if (hasAndroidVersion()) {
            iComputeUInt32Size += CodedOutputStreamMicro.computeStringSize(13, getAndroidVersion());
        }
        if (hasServiceVersion()) {
            iComputeUInt32Size += CodedOutputStreamMicro.computeStringSize(14, getServiceVersion());
        }
        Iterator<String> it2 = getAkList().iterator();
        int iComputeStringSizeNoTag2 = 0;
        while (it2.hasNext()) {
            iComputeStringSizeNoTag2 += CodedOutputStreamMicro.computeStringSizeNoTag(it2.next());
        }
        int size = iComputeUInt32Size + iComputeStringSizeNoTag2 + (getAkList().size() * 1);
        if (hasPhoneType()) {
            size += CodedOutputStreamMicro.computeStringSize(16, getPhoneType());
        }
        Iterator<String> it3 = getAppNameList().iterator();
        while (it3.hasNext()) {
            iComputeStringSizeNoTag += CodedOutputStreamMicro.computeStringSizeNoTag(it3.next());
        }
        int size2 = size + iComputeStringSizeNoTag + (getAppNameList().size() * 2);
