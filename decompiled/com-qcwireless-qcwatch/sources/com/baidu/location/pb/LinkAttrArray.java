...
public final class LinkAttrArray extends MessageMicro {
    ...
    public int getSerializedSize() {
        int iComputeUInt32Size = hasGeoEncodeFlag() ? 0 + CodedOutputStreamMicro.computeUInt32Size(1, getGeoEncodeFlag()) : 0;
        Iterator<LinkAttrt> it = getLinkAttrsList().iterator();
        while (it.hasNext()) {
            iComputeUInt32Size += CodedOutputStreamMicro.computeMessageSize(2, it.next());
        }
