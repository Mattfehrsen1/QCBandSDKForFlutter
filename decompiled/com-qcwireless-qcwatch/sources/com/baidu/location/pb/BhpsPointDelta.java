...
public final class BhpsPointDelta extends MessageMicro {
    ...
    public int getSerializedSize() {
        int iComputeDoubleSize = hasDeltaLongitude() ? 0 + CodedOutputStreamMicro.computeDoubleSize(1, getDeltaLongitude()) : 0;
        if (hasDeltaLatitude()) {
            iComputeDoubleSize += CodedOutputStreamMicro.computeDoubleSize(2, getDeltaLatitude());
        }
        if (hasGpsSpeed()) {
            iComputeDoubleSize += CodedOutputStreamMicro.computeDoubleSize(3, getGpsSpeed());
        }
        if (hasGpsAngle()) {
            iComputeDoubleSize += CodedOutputStreamMicro.computeDoubleSize(4, getGpsAngle());
        }
        if (hasGpsTime()) {
            iComputeDoubleSize += CodedOutputStreamMicro.computeUInt64Size(5, getGpsTime());
        }
        if (hasGpsStat()) {
            iComputeDoubleSize += CodedOutputStreamMicro.computeUInt32Size(6, getGpsStat());
        }
        if (hasTurnDir()) {
            iComputeDoubleSize += CodedOutputStreamMicro.computeUInt32Size(7, getTurnDir());
        }
        if (hasTurnDist()) {
            iComputeDoubleSize += CodedOutputStreamMicro.computeUInt32Size(8, getTurnDist());
        }
        if (hasDriverState()) {
            iComputeDoubleSize += CodedOutputStreamMicro.computeUInt32Size(9, getDriverState());
        }
        if (hasLocationRadius()) {
            iComputeDoubleSize += CodedOutputStreamMicro.computeUInt32Size(10, getLocationRadius());
        }
        if (hasHeight()) {
            iComputeDoubleSize += CodedOutputStreamMicro.computeUInt32Size(11, getHeight());
        }
        if (hasAltitude()) {
            iComputeDoubleSize += CodedOutputStreamMicro.computeInt32Size(12, getAltitude());
        }
        if (hasWalkingState()) {
            iComputeDoubleSize += CodedOutputStreamMicro.computeInt32Size(13, getWalkingState());
        }
        this.cachedSize = iComputeDoubleSize;
