...
public final class NrCellValue extends MessageMicro {
    ...
    public int getSerializedSize() {
        int iComputeUInt64Size = hasCi() ? 0 + CodedOutputStreamMicro.computeUInt64Size(1, getCi()) : 0;
        if (hasPci()) {
            iComputeUInt64Size += CodedOutputStreamMicro.computeInt32Size(2, getPci());
        }
        if (hasTac()) {
            iComputeUInt64Size += CodedOutputStreamMicro.computeInt32Size(3, getTac());
        }
        if (hasNrarfcn()) {
            iComputeUInt64Size += CodedOutputStreamMicro.computeInt32Size(4, getNrarfcn());
        }
        if (hasSsrsrp()) {
            iComputeUInt64Size += CodedOutputStreamMicro.computeInt32Size(5, getSsrsrp());
        }
        if (hasSsrsrq()) {
            iComputeUInt64Size += CodedOutputStreamMicro.computeInt32Size(6, getSsrsrq());
        }
        if (hasSssinr()) {
            iComputeUInt64Size += CodedOutputStreamMicro.computeInt32Size(7, getSssinr());
        }
        if (hasCsirsrp()) {
            iComputeUInt64Size += CodedOutputStreamMicro.computeInt32Size(8, getCsirsrp());
        }
        if (hasCsirsrq()) {
            iComputeUInt64Size += CodedOutputStreamMicro.computeInt32Size(9, getCsirsrq());
        }
        if (hasCsisinr()) {
            iComputeUInt64Size += CodedOutputStreamMicro.computeInt32Size(10, getCsisinr());
        }
