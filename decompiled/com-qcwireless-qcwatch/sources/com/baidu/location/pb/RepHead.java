...
public final class RepHead extends MessageMicro {
    ...
    public static final class MessageHead extends MessageMicro {
        ...
        public int getSerializedSize() {
            int iComputeInt32Size = hasOffset() ? 0 + CodedOutputStreamMicro.computeInt32Size(1, getOffset()) : 0;
            if (hasLength()) {
                iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(2, getLength());
            }
            if (hasName()) {
                iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(3, getName());
            }
    ...
    @Override // com.google.protobuf.micro.MessageMicro
    public int getSerializedSize() {
        int iComputeStringSize = hasMd5() ? 0 + CodedOutputStreamMicro.computeStringSize(1, getMd5()) : 0;
        if (hasRange()) {
            iComputeStringSize += CodedOutputStreamMicro.computeStringSize(2, getRange());
        }
        Iterator<MessageHead> it = getMessageHeadList().iterator();
        while (it.hasNext()) {
            iComputeStringSize += CodedOutputStreamMicro.computeMessageSize(3, it.next());
        }
