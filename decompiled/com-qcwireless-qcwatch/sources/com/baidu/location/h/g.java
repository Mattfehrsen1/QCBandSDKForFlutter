...
public class g {
    ...
    class b {
        ...
        double a(a aVar) {
            a aVar2 = g.this.new a(this.b.a - this.a.a, this.b.b - this.a.b);
            a aVar3 = g.this.new a(aVar.a - this.a.a, aVar.b - this.a.b);
            return (aVar2.a * aVar3.b) - (aVar2.b * aVar3.a);
        }

        boolean b(a aVar) {
            return g.this.a(a(aVar)) == 0 && aVar.a < Math.max(this.a.a, this.b.a) + 1.0E-8d && aVar.a > Math.min(this.a.a, this.b.a) - 1.0E-8d && aVar.b < Math.max(this.a.b, this.b.b) + 1.0E-8d && aVar.b > Math.min(this.a.b, this.b.b) - 1.0E-8d;
        }
    }
    ...
    private g() {
        ...
        while (i < length - 1) {
            ...
            double[] dArr = b;
            double d = dArr[i] * 100000.0d;
            double[] dArr2 = c;
            a aVar = new a(d, dArr2[i] * 100000.0d);
            i++;
            linkedList.add(new b(aVar, new a(dArr[i] * 100000.0d, dArr2[i] * 100000.0d)));
        }
    }
    ...
    public boolean a(double d, double d2) {
        try {
            a aVar = new a(d * 100000.0d, d2 * 100000.0d);
            ...
            while (it.hasNext()) {
                ...
                int iA = a(next.a(aVar));
                int iA2 = a(next.a.b - aVar.b);
                int iA3 = a(next.b.b - aVar.b);
                if (iA > 0 && iA2 <= 0 && iA3 > 0) {
                    i++;
                }
                if (iA < 0 && iA3 <= 0 && iA2 > 0) {
