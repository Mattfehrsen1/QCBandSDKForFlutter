...
public class r {
    ...
    private static File c = new File(com.baidu.location.h.r.a, b);
    ...
    public static String a() throws IOException {
        ...
        if (i3 != 0 && i3 != i4) {
            ...
            int i8 = 1;
            if (i2 < com.baidu.location.h.s.ae) {
                i5 = i3 + 1;
            } else {
                if (i3 != com.baidu.location.h.s.ae) {
                    i8 = 1 + i3;
                }
                i5 = i8;
            }
    ...
    private static boolean a(int i2, int i3, int i4) {
        int i5;
        return i2 >= 0 && i2 <= com.baidu.location.h.s.ae && i3 >= 0 && i3 <= (i5 = i2 + 1) && i4 >= 1 && i4 <= i5 && i4 <= com.baidu.location.h.s.ae;
    }
