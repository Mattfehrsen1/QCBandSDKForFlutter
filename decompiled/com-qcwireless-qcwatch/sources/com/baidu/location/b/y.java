...
public class y {
    ...
    private class a extends Handler {
        ...
        private String a(BDLocation bDLocation) throws JSONException {
            try {
        ...
        private void a(String str) {
            if (y.this.l) {
                y.this.e.removeCallbacks(y.this.k);
                y.this.l = false;
            }
            ...
            while (it.hasNext()) {
                try {
                    b bVar = (b) it.next();
                    if (bVar.b() != null) {
                        y.this.c.loadUrl("javascript:" + bVar.b() + "('" + str + "')");
                    }
                    it.remove();
                } catch (Exception unused) {
                    return;
        ...
        */
        public void handleMessage(android.os.Message r10) throws org.json.JSONException {
            /*
                Method dump skipped, instructions count: 382
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: com.baidu.location.b.y.a.handleMessage(android.os.Message):void");
        }
    }
    ...
    private class d {
        ...
        public void sendMessage(String str) {
            if (str == null || !y.this.g) {
                return;
            }
            b bVar = y.this.new b(str);
            if (bVar.a() == null || !bVar.a().equals("requestLoc") || y.this.e == null) {
                return;
            }
            Message messageObtainMessage = y.this.e.obtainMessage(1);
    ...
    public class e extends BDAbstractLocationListener {
        ...
        public void onReceiveLocation(BDLocation bDLocation) {
            ...
            if (locType == 61 || locType == 161 || locType == 66) {
                ...
                y.this.i = new BDLocation(bDLocation2);
                messageObtainMessage = y.this.e.obtainMessage(2);
                messageObtainMessage.obj = bDLocation2;
            } else {
                messageObtainMessage = y.this.e.obtainMessage(5);
            }
            messageObtainMessage.sendToTarget();
        }
    }
    ...
    private class f implements Runnable {
        ...
        public void run() {
            y.this.l = false;
            y.this.e.obtainMessage(6).sendToTarget();
        }
    }
