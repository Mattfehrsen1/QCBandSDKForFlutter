...
public class c {
    ...
    public void b() {
        if (Build.VERSION.SDK_INT >= 31 && s.aF != 0) {
            if (!s.l()) {
                c();
                return;
            }
    ...
    public Location d() {
        return System.currentTimeMillis() - this.d < WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS ? this.c : System.currentTimeMillis() - this.e < WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS ? this.b : null;
    }
}
