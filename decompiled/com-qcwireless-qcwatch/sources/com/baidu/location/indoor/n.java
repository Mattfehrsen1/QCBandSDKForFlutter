...
public class n implements SensorEventListener {
    ...
    class b {
        ...
        public int a(BDLocation bDLocation) {
            ...
            try {
                ...
                if (this.f.size() == 0) {
                    ...
                    while (it2.hasNext()) {
                        dDoubleValue2 += it2.next().doubleValue();
                    }
                    for (int i = 0; i < arrayList.size(); i++) {
                        arrayList2.set(i, map.containsKey(arrayList.get(i)) ? (Double) map.get(arrayList.get(i)) : Double.valueOf((1.0d - dDoubleValue2) / (this.h - map.size())));
                    }
                    ...
                    for (int i3 = 0; i3 < this.f.size(); i3++) {
                        Double d = this.e.get(i3);
                        ArrayList<Double> arrayListA = a(arrayList, this.f.get(i3));
                        for (int i4 = 0; i4 < arrayList.size(); i4++) {
                            arrayList3.set(i4, Double.valueOf(arrayList3.get(i4).doubleValue() + (d.doubleValue() * arrayListA.get(i4).doubleValue() * ((Double) arrayList2.get(i4)).doubleValue())));
                        }
                    }
                    this.f = arrayList;
                    this.e = a(arrayList3);
                ...
                for (int i5 = 0; i5 < this.f.size(); i5++) {
                    if (this.e.get(i5).doubleValue() > dDoubleValue) {
                        dDoubleValue = this.e.get(i5).doubleValue();
                        str = this.f.get(i5);
                    }
                }
                this.a = str;
        ...
        private int b(String str) {
            try {
                ...
                this.h = Integer.parseInt(strArrSplit[0]);
                this.g = new HashMap();
                for (int i = 1; i < strArrSplit.length; i++) {
                    String[] strArrSplit2 = strArrSplit[i].split(":");
                    this.g.put(strArrSplit2[0], Double.valueOf(Double.parseDouble(strArrSplit2[1])));
                }
                return 0;
            } catch (Exception unused) {
                return 1;
    ...
    class c {
        ...
        public double a(double d, double d2, double d3, double d4) {
            double[] dArrA = a(d2, d3);
            double dAbs = Math.abs(d4 - dArrA[0]);
            return dAbs > dArrA[1] * 2.0d ? d + dAbs : d;
        }
    ...
    class e {
        ...
        public void a(Location location, boolean z) {
            ...
            if (this.t <= 10 || System.currentTimeMillis() - this.c <= WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS) {
                return;
            }
            n.this.d();
        }
        ...
        public boolean a(double d, double d2, double d3) {
            ...
            long j = this.f;
            if (j != 0 && jCurrentTimeMillis - j > WorkRequest.MIN_BACKOFF_MILLIS) {
                return true;
            }
            if (this.q >= 5 && d3 < 15.0d && jCurrentTimeMillis - this.c > 20000) {
                float[] fArr = new float[2];
        ...
        public boolean a(BDLocation bDLocation, double d, String str) {
            ...
            long j = this.s;
            if (j != 0 && jCurrentTimeMillis - j > WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS && jCurrentTimeMillis - this.j < WorkRequest.MIN_BACKOFF_MILLIS && jCurrentTimeMillis - this.k < WorkRequest.MIN_BACKOFF_MILLIS) {
                return false;
            }
            if (this.t > 10 && jCurrentTimeMillis - this.c > WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS) {
                return false;
            }
            if (jCurrentTimeMillis - this.g > WorkRequest.MIN_BACKOFF_MILLIS && jCurrentTimeMillis - this.c > WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS) {
                return false;
            }
            long j2 = this.f;
            return j2 == 0 || jCurrentTimeMillis - j2 <= 60000;
        }
        ...
        public boolean b() {
            ...
            if (!com.baidu.location.f.h.a().p().contains("&wifio") && n.this.c != 1) {
                return false;
            }
            this.u = 1;
            return true;
        ...
        private boolean c() {
            long jCurrentTimeMillis = System.currentTimeMillis();
            if (jCurrentTimeMillis - this.h < WorkRequest.MIN_BACKOFF_MILLIS && jCurrentTimeMillis - this.c > WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS) {
                return false;
            }
            if (jCurrentTimeMillis - this.k >= WorkRequest.MIN_BACKOFF_MILLIS) {
                return true;
            }
            long j = this.j;
            return j == 0 || jCurrentTimeMillis - j <= 16000 || jCurrentTimeMillis - this.c <= WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS;
        }
        ...
        public void d() {
            ...
            if (pVar == null || !pVarU.a(pVar)) {
                if (jCurrentTimeMillis - this.s < WorkRequest.MIN_BACKOFF_MILLIS) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public boolean e() {
            if (this.u == 1 || !c() || this.b > 25.0d || System.currentTimeMillis() - this.i > WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS) {
                return false;
            }
    ...
    class g {
        ...
        public void a(BDLocation bDLocation) {
            this.c.add(new a(bDLocation.getLongitude(), bDLocation.getLatitude(), n.this.ag.b));
        }
    ...
    class h extends Thread {
        ...
        public void run() throws InterruptedException {
            ...
            while (this.b) {
                ...
                if (n.this.l && n.this.ag != null && System.currentTimeMillis() - n.this.o > WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS && System.currentTimeMillis() - n.this.ag.f > WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS) {
                    n.a().d();
                }
                try {
                    Thread.sleep(1000L);
    ...
    class j extends com.baidu.location.h.h {
        ...
        public void a() {
            ...
            if (n.this.c != 1 || n.this.d || System.currentTimeMillis() - this.f >= WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS || System.currentTimeMillis() - n.this.ag.c <= WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS) {
                long jCurrentTimeMillis = System.currentTimeMillis() - this.h;
                if (jCurrentTimeMillis >= 1000 || jCurrentTimeMillis <= 0) {
                    StringBuffer stringBuffer = new StringBuffer(1024);
                    String strB = com.baidu.location.f.h.a().b(com.baidu.location.f.h.a().f());
                    String strF = com.baidu.location.f.e.a().f();
                    ...
                    com.baidu.location.f.p pVarU = com.baidu.location.f.h.a().u();
                    String strA = n.this.a(pVarU);
                    if (strA == null) {
                        strA = com.baidu.location.f.h.a().a(n.this.e, true, pVarU, com.baidu.location.h.s.ay);
                    }
                    if (!z) {
                    ...
                    if (strA != null && !"null".equals(strA) && !"".equals(strA)) {
                        stringBuffer.append(strA);
                    }
                    String strD = v.a().d();
                    if (n.this.M <= 2 && strD != null) {
                        stringBuffer.append("&idsl=" + strD);
                    }
                    ...
                    String strD2 = com.baidu.location.b.c.a().d();
                    if (strD2 != null) {
                    ...
                    this.d = string;
                    if (string.length() > com.baidu.location.h.s.aN) {
                        String[] strArrSplit = this.d.split("&cl_list=");
                        if (strArrSplit.length == 2) {
                            String[] strArrSplit2 = strArrSplit[1].split("&", 2);
                            if (strArrSplit2.length == 2) {
                                str = strArrSplit[0] + "&cl_list=null&" + strArrSplit2[1];
                            } else {
                                str = strArrSplit[0] + "&cl_list=null";
                            }
                            this.d = str;
                        }
                    }
        ...
        public void a(boolean z) throws JSONException {
            if (!z || this.eg == null) {
                ...
                try {
                    ...
                    } else if (strB.contains("enc") && com.baidu.location.b.w.a().b()) {
                        try {
                            JSONObject jSONObject = new JSONObject(strB);
                            if (jSONObject.has("enc")) {
                                strB = com.baidu.location.b.w.a().b(jSONObject.getString("enc"));
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    ...
                    BDLocation bDLocation = new BDLocation(strB);
                    ...
                    if (indoorLocationSurpportBuidlingName != null && !n.this.O.a(indoorLocationSurpportBuidlingName)) {
                        n.this.O.a(indoorLocationSurpportBuidlingName, (a.InterfaceC0025a) null);
                    }
                    if (n.this.Q != null) {
                    ...
                    if (bDLocation.getFloor() != null) {
                        ...
                        long jCurrentTimeMillis = System.currentTimeMillis();
                        this.i = jCurrentTimeMillis;
                        int i = (int) (jCurrentTimeMillis - this.h);
                        if (i > 10000) {
                            n.this.V = 0;
                        } else if (i < 3000) {
                            n.this.V = 2;
        ...
        public void b() {
            ...
            String strEncodeTp4 = Jni.encodeTp4(this.d);
            this.d = null;
    ...
    public String a(com.baidu.location.f.p pVar) {
        ...
        int iA = pVar.a();
        if (iA <= this.e) {
            strA = com.baidu.location.f.h.a().a(this.e, true, pVar, com.baidu.location.h.s.ay);
            str = "&aprk=0";
        ...
        if (this.l) {
            ...
            if (bDLocation.getLocType() == 161) {
                ...
                if (bDLocation.getBuildingID() != null && bDLocation.getFloor() != null) {
                    ...
                    String strL = l();
                    if (floor != null && strL != null && !floor.equals(strL)) {
                        return;
                    }
                    if (this.u == null) {
                    ...
                    this.u = bDLocation.getFloor();
                    double dC = v.a().c();
                    if (dC >= 0.0d && bDLocation.getDirection() <= 0.0f) {
                        bDLocation.setDirection((float) dC);
                    }
                    double[] dArrA = com.baidu.location.indoor.mapversion.a.a.a(this.S, bDLocation);
                    if (dArrA != null && dArrA[0] != -1.0d && dArrA[0] == 0.0d) {
                        ...
                        if (!this.ag.a(bDLocation, dArrA[5], "wifi")) {
                            d();
                            return;
                        }
                    }
                } else if (i() && (z = this.S)) {
                    double[] dArrA2 = com.baidu.location.indoor.mapversion.a.a.a(z, bDLocation);
                    if (dArrA2 != null && dArrA2[0] != -1.0d && dArrA2[0] == 0.0d) {
                        bDLocation.setLongitude(dArrA2[1]);
                        bDLocation.setLatitude(dArrA2[2]);
                        bDLocation.setFusionLocInfo("res", dArrA2);
                        bDLocation.setRadius((float) dArrA2[5]);
                        bDLocation.setDirection((float) dArrA2[6]);
                        bDLocation.setSpeed((float) dArrA2[8]);
                        if (!this.ag.a(bDLocation, dArrA2[5], "wifi")) {
                            d();
                            return;
                        }
                    }
    ...
    public void a(BDLocation bDLocation, int i2) {
        ...
        if (i()) {
            ...
            if (iA == 1 || iA == 2) {
                ...
                com.baidu.location.indoor.c cVarB = com.baidu.location.indoor.d.a().b();
                if (cVarB != null && cVarB.d() == 1) {
                    strB = m.b();
                    if (!"".equals(strB) && !"unknow".equals(strB)) {
                        bDLocation.setBuildingID(strB);
                    }
                }
                if ((iA != 2 || iA == 0) && com.baidu.location.f.e.a().k() && (locationH = com.baidu.location.f.e.a().h()) != null) {
                    double[] dArrCoorEncrypt = Jni.coorEncrypt(locationH.getLongitude(), locationH.getLatitude(), BDLocation.BDLOCATION_WGS84_TO_GCJ02);
                ...
                if (iA != 2) {
                    double[] dArrCoorEncrypt2 = Jni.coorEncrypt(locationH.getLongitude(), locationH.getLatitude(), BDLocation.BDLOCATION_WGS84_TO_GCJ02);
                    bDLocation.setLongitude(dArrCoorEncrypt2[0]);
                    bDLocation.setLatitude(dArrCoorEncrypt2[1]);
                } else {
                    double[] dArrCoorEncrypt22 = Jni.coorEncrypt(locationH.getLongitude(), locationH.getLatitude(), BDLocation.BDLOCATION_WGS84_TO_GCJ02);
                    bDLocation.setLongitude(dArrCoorEncrypt22[0]);
                    bDLocation.setLatitude(dArrCoorEncrypt22[1]);
                }
            }
        }
        if (bDLocation.getNetworkLocationType().startsWith("vps")) {
            ...
            com.baidu.location.b.c.a().a(bDLocation);
            return;
        }
        if (this.W != null) {
        ...
        if (bDLocation.getNetworkLocationType().contains("2")) {
            ...
            Message messageObtainMessage = this.a.obtainMessage(801);
    ...
    private void a(String str, String str2) throws IOException {
        ...
        com.baidu.location.indoor.mapversion.b.a aVarA = com.baidu.location.indoor.mapversion.b.a.a();
        aVarA.a("gcj02");
        aVarA.a(str, new q(this, str, str2));
    }
    ...
    private String l() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            try {
                ...
                str3 = str3 + str4 + LogUtils.VERTICAL;
                map.put(str4, map.containsKey(str4) ? Integer.valueOf(((Integer) map.get(str4)).intValue() + 1) : 1);
            } catch (Exception unused) {
                return this.u;
            }
        }
        for (String str5 : map.keySet()) {
            if (((Integer) map.get(str5)).intValue() > iIntValue) {
                iIntValue = ((Integer) map.get(str5)).intValue();
                str2 = str5;
            }
        }
    ...
    */
    public boolean a(double r9, double r11) {
        ...
        L2a:
            ...
            java.lang.String r9 = r4.g     // Catch: java.lang.Exception -> L5b java.util.ConcurrentModificationException -> L60
            goto L64
        L5b:
            r9 = move-exception
            r9.printStackTrace()
    ...
    public boolean a(Location location, ArrayList<ArrayList<Float>> arrayList) {
        ...
        if (i()) {
            ...
            m.a(dArrCoorEncrypt[0], dArrCoorEncrypt[1], location.getAccuracy(), location.getSpeed(), location.getBearing(), location.getAltitude(), size, System.currentTimeMillis());
        }
        if (size == 0 || !com.baidu.location.f.e.a().k() || (!this.l && location.getSpeed() > 3.0f)) {
            return false;
        }
        double[] dArrCoorEncrypt2 = Jni.coorEncrypt(location.getLongitude(), location.getLatitude(), BDLocation.BDLOCATION_WGS84_TO_GCJ02);
        double d2 = dArrCoorEncrypt2[0];
        double d3 = dArrCoorEncrypt2[1];
