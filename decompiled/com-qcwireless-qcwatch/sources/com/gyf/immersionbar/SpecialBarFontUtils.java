...
class SpecialBarFontUtils {
    ...
    static void setMIUIBarDark(Window window, String str, boolean z) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (window != null) {
