    ...
    */
    public void onResourceReady(com.bumptech.glide.load.engine.Resource<?> r6, com.bumptech.glide.load.DataSource r7, boolean r8) {
        /*
            ...
            r0.throwIfRecycled()
            r0 = 0
            java.lang.Object r1 = r5.requestLock     // Catch: java.lang.Throwable -> Lc3
            monitor-enter(r1)     // Catch: java.lang.Throwable -> Lc3
            r5.loadStatus = r0     // Catch: java.lang.Throwable -> Lc0
            if (r6 != 0) goto L2f
        ...
        L2f:
            ...
            goto L63
        L42:
            boolean r3 = r5.canSetResource()     // Catch: java.lang.Throwable -> Lc0
            if (r3 != 0) goto L5e
            r5.resource = r0     // Catch: java.lang.Throwable -> Lbc
            ...
            r5.status = r7     // Catch: java.lang.Throwable -> Lbc
            java.lang.String r7 = "GlideRequest"
            int r8 = r5.cookie     // Catch: java.lang.Throwable -> Lbc
            com.bumptech.glide.util.pool.GlideTrace.endSectionAsync(r7, r8)     // Catch: java.lang.Throwable -> Lbc
        ...
        L5d:
            return
        L5e:
            r5.onResourceReady(r6, r2, r7, r8)     // Catch: java.lang.Throwable -> Lc0
            monitor-exit(r1)     // Catch: java.lang.Throwable -> Lc0
            return
        L63:
            r5.resource = r0     // Catch: java.lang.Throwable -> Lbc
            ...
            java.lang.Class<R> r0 = r5.transcodeClass     // Catch: java.lang.Throwable -> Lbc
            r8.append(r0)     // Catch: java.lang.Throwable -> Lbc
        ...
        La6:
            ...
            r5.onLoadFailed(r7)     // Catch: java.lang.Throwable -> Lbc
            monitor-exit(r1)     // Catch: java.lang.Throwable -> Lbc
            if (r6 == 0) goto Lbb
            com.bumptech.glide.load.engine.Engine r7 = r5.engine
            r7.release(r6)
