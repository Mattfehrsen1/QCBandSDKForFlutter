...
public abstract class BaseQuickAdapter<T, VH extends BaseViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public VH onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case HEADER_VIEW /* 268435729 */:
                ...
                return (VH) createBaseViewHolder((View) callback);
        ...
        if (this.mOnItemClickListener != null) {
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.chad.library.adapter.base.BaseQuickAdapter$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    BaseQuickAdapter.m209bindViewClickListener$lambda7$lambda6(viewHolder, this, view);
                }
            });
        }
        if (this.mOnItemLongClickListener != null) {
            viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.chad.library.adapter.base.BaseQuickAdapter$$ExternalSyntheticLambda2
                ...
                public final boolean onLongClick(View view) {
                    return BaseQuickAdapter.m210bindViewClickListener$lambda9$lambda8(viewHolder, this, view);
                }
            });
        }
        if (this.mOnItemChildClickListener != null) {
            ...
            while (it.hasNext()) {
                ...
                if (viewFindViewById != null) {
                    ...
                    viewFindViewById.setOnClickListener(new View.OnClickListener() { // from class: com.chad.library.adapter.base.BaseQuickAdapter$$ExternalSyntheticLambda1
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                            BaseQuickAdapter.m207bindViewClickListener$lambda12$lambda11$lambda10(viewHolder, this, view2);
                        }
                    });
                }
            }
        ...
        if (this.mOnItemChildLongClickListener != null) {
            ...
            while (it2.hasNext()) {
                ...
                if (viewFindViewById2 != null) {
                    ...
                    viewFindViewById2.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.chad.library.adapter.base.BaseQuickAdapter$$ExternalSyntheticLambda3
                        @Override // android.view.View.OnLongClickListener
                        public final boolean onLongClick(View view3) {
                            return BaseQuickAdapter.m208bindViewClickListener$lambda15$lambda14$lambda13(viewHolder, this, view3);
                        }
                    });
                }
            }
    ...
    public static final void m209bindViewClickListener$lambda7$lambda6(BaseViewHolder viewHolder, BaseQuickAdapter this$0, View v) {
        Intrinsics.checkNotNullParameter(viewHolder, "$viewHolder");
    ...
    public static final boolean m210bindViewClickListener$lambda9$lambda8(BaseViewHolder viewHolder, BaseQuickAdapter this$0, View v) {
        Intrinsics.checkNotNullParameter(viewHolder, "$viewHolder");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        int bindingAdapterPosition = viewHolder.getBindingAdapterPosition();
        if (bindingAdapterPosition == -1) {
    ...
    public static final void m207bindViewClickListener$lambda12$lambda11$lambda10(BaseViewHolder viewHolder, BaseQuickAdapter this$0, View v) {
        Intrinsics.checkNotNullParameter(viewHolder, "$viewHolder");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        int bindingAdapterPosition = viewHolder.getBindingAdapterPosition();
        if (bindingAdapterPosition == -1) {
    ...
    public static final boolean m208bindViewClickListener$lambda15$lambda14$lambda13(BaseViewHolder viewHolder, BaseQuickAdapter this$0, View v) {
        Intrinsics.checkNotNullParameter(viewHolder, "$viewHolder");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        int bindingAdapterPosition = viewHolder.getBindingAdapterPosition();
        if (bindingAdapterPosition == -1) {
    ...
    private final void addAnimation(RecyclerView.ViewHolder holder) {
        if (this.animationEnable) {
            if (!this.isAnimationFirstOnly || holder.getLayoutPosition() > this.mLastPosition) {
                ...
                Animator[] animatorArrAnimators = alphaInAnimation.animators(view);
                for (Animator animator : animatorArrAnimators) {
