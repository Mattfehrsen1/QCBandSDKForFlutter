...
final class PermissionChecker {
    ...
    static void checkMediaLocationPermission(Context context, List<String> list) {
        if (PermissionUtils.containsPermission(list, Permission.ACCESS_MEDIA_LOCATION)) {
            for (String str : list) {
                if (!PermissionUtils.equalsPermission(str, Permission.ACCESS_MEDIA_LOCATION) && !PermissionUtils.equalsPermission(str, "android.permission.READ_MEDIA_IMAGES") && !PermissionUtils.equalsPermission(str, "android.permission.READ_EXTERNAL_STORAGE") && !PermissionUtils.equalsPermission(str, "android.permission.WRITE_EXTERNAL_STORAGE") && !PermissionUtils.equalsPermission(str, Permission.MANAGE_EXTERNAL_STORAGE)) {
            ...
            if (AndroidVersion.getTargetSdkVersionCode(context) >= 33) {
                if (!PermissionUtils.containsPermission(list, "android.permission.READ_MEDIA_IMAGES") && !PermissionUtils.containsPermission(list, Permission.MANAGE_EXTERNAL_STORAGE)) {
            ...
            } else if (!PermissionUtils.containsPermission(list, "android.permission.READ_EXTERNAL_STORAGE") && !PermissionUtils.containsPermission(list, Permission.MANAGE_EXTERNAL_STORAGE)) {
    ...
    static void checkStoragePermission(Context context, List<String> list, AndroidManifestInfo androidManifestInfo) {
        ...
        if (PermissionUtils.containsPermission(list, "android.permission.READ_MEDIA_IMAGES") || PermissionUtils.containsPermission(list, "android.permission.READ_MEDIA_VIDEO") || PermissionUtils.containsPermission(list, "android.permission.READ_MEDIA_AUDIO") || PermissionUtils.containsPermission(list, Permission.MANAGE_EXTERNAL_STORAGE) || PermissionUtils.containsPermission(list, "android.permission.READ_EXTERNAL_STORAGE") || PermissionUtils.containsPermission(list, "android.permission.WRITE_EXTERNAL_STORAGE")) {
            if (AndroidVersion.getTargetSdkVersionCode(context) >= 33 && PermissionUtils.containsPermission(list, "android.permission.READ_EXTERNAL_STORAGE")) {
            ...
            if (PermissionUtils.containsPermission(list, "android.permission.READ_MEDIA_IMAGES") || PermissionUtils.containsPermission(list, Permission.ACCESS_MEDIA_LOCATION) || androidManifestInfo == null || (applicationInfo = androidManifestInfo.applicationInfo) == null) {
                return;
            }
    ...
    static void optimizeDeprecatedPermission(List<String> list) {
        ...
        if (PermissionUtils.containsPermission(list, Permission.MANAGE_EXTERNAL_STORAGE)) {
            if (PermissionUtils.containsPermission(list, "android.permission.READ_EXTERNAL_STORAGE") || PermissionUtils.containsPermission(list, "android.permission.WRITE_EXTERNAL_STORAGE")) {
