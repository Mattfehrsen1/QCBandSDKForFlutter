...
public class Util {
    ...
    public static String md5(String str) {
        byte[] bArrDigest;
        try {
            bArrDigest = MessageDigest.getInstance("MD5").digest(str.getBytes(Key.STRING_CHARSET_NAME));
    ...
    public static boolean isUriContentScheme(Uri uri) {
        return uri.getScheme().equals(Constant.MODIFY_ACTIVITY_INTENT_CONTENT);
    }
