...
public class ColorKeyframeAnimation extends KeyframeAnimation<Integer> {
    ...
    public int getIntValue(Keyframe<Integer> keyframe, float f) {
        ...
        if (this.valueCallback != null && (num = (Integer) this.valueCallback.getValueInternal(keyframe.startFrame, keyframe.endFrame.floatValue(), Integer.valueOf(iIntValue), Integer.valueOf(iIntValue2), f, getLinearCurrentKeyframeProgress(), getProgress())) != null) {
            return num.intValue();
        }
