...
public class GradientFillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    private RadialGradient getRadialGradient() {
        ...
        RadialGradient radialGradient2 = new RadialGradient(f, f2, fHypot <= 0.0f ? 0.001f : fHypot, iArrApplyDynamicColorsIfNeeded, positions, Shader.TileMode.CLAMP);
    ...
    private int getGradientHash() {
        ...
        int i = iRound != 0 ? GattClient.STATE_PREPARED * iRound : 17;
        if (iRound2 != 0) {
            i = i * 31 * iRound2;
        }
