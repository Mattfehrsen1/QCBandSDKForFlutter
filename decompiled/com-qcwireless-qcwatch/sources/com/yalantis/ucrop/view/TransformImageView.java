...
public class TransformImageView extends AppCompatImageView {
    ...
    public void setImageUri(Uri uri, Uri uri2, boolean z) throws FileNotFoundException {
    ...
    private void useCustomLoaderCrop(final Uri uri, final Uri uri2) throws FileNotFoundException {
    ...
    public void setBitmapLoadedResult(Bitmap bitmap, ExifInfo exifInfo, Uri uri, Uri uri2) {
        ...
        if (uri2 != null) {
            string = FileUtils.isContent(uri2.toString()) ? uri2.toString() : uri2.getPath();
        } else {
            string = null;
        }
