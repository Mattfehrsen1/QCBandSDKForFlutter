...
public class Logger {
    ...
    private void printlnInternal(int i, String str) {
        ...
        String str3 = this.logConfiguration.withThread ? this.logConfiguration.threadFormatter.format(Thread.currentThread()) : null;
        String str4 = this.logConfiguration.withStackTrace ? this.logConfiguration.stackTraceFormatter.format(StackTraceUtil.getCroppedRealStackTrack(new Throwable().getStackTrace(), this.logConfiguration.stackTraceOrigin, this.logConfiguration.stackTraceDepth)) : null;
        if (this.logConfiguration.interceptors != null) {
            LogItem logItem = new LogItem(i, str2, str3, str4, str);
        ...
        if (this.logConfiguration.withBorder) {
            string = this.logConfiguration.borderFormatter.format(new String[]{str3, str4, str});
        } else {
            StringBuilder sb = new StringBuilder();
            sb.append(str3 != null ? str3 + SystemCompat.lineSeparator : "");
            sb.append(str4 != null ? str4 + SystemCompat.lineSeparator : "");
            sb.append(str);
            string = sb.toString();
        }
        printer.println(i, str2, string);
    }
