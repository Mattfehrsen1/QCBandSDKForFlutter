...
public final class SportDetailCalorieActivity extends BaseActivity {
    ...
    public SportDetailCalorieActivity() {
        ...
        this.detailViewModel = LazyKt.lazy(new Function0<SportDetailViewModel>() { // from class: com.qcwireless.qcwatch.ui.home.sport.SportDetailCalorieActivity$special$$inlined$viewModel$default$1
            ...
            public final SportDetailViewModel invoke() {
                return LifecycleOwnerExtKt.getViewModel(sportDetailCalorieActivity, Reflection.getOrCreateKotlinClass(SportDetailViewModel.class), qualifier, objArr);
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivitySportDetailCalorieBinding activitySportDetailCalorieBindingInflate = ActivitySportDetailCalorieBinding.inflate(getLayoutInflater());
        Intrinsics.checkNotNullExpressionValue(activitySportDetailCalorieBindingInflate, "inflate(layoutInflater)");
        this.binding = activitySportDetailCalorieBindingInflate;
        if (activitySportDetailCalorieBindingInflate == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
            activitySportDetailCalorieBindingInflate = null;
        }
        ConstraintLayout root = activitySportDetailCalorieBindingInflate.getRoot();
    ...
    protected void setupViews() {
        ...
        try {
            if (UserConfig.INSTANCE.getInstance().getHeartSupport()) {
                ...
                ViewKt.gone(activitySportDetailCalorieBinding2.supportHeart);
                ...
                ViewKt.gone(activitySportDetailCalorieBinding3.sportHeart);
            } else {
                ActivitySportDetailCalorieBinding activitySportDetailCalorieBinding4 = this.binding;
                if (activitySportDetailCalorieBinding4 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("binding");
                    activitySportDetailCalorieBinding4 = null;
                }
                ViewKt.visible(activitySportDetailCalorieBinding4.supportHeart);
                ActivitySportDetailCalorieBinding activitySportDetailCalorieBinding5 = this.binding;
                if (activitySportDetailCalorieBinding5 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("binding");
                    activitySportDetailCalorieBinding5 = null;
                }
                ViewKt.visible(activitySportDetailCalorieBinding5.sportHeart);
            }
        ...
        ActivitySportDetailCalorieBinding activitySportDetailCalorieBinding6 = this.binding;
        if (activitySportDetailCalorieBinding6 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
            activitySportDetailCalorieBinding6 = null;
        }
        activitySportDetailCalorieBinding6.titleBar.tvTitle.setText(getString(R.string.qc_text_83));
        ...
        getDetailViewModel().getAge().observe(sportDetailCalorieActivity, new Observer() { // from class: com.qcwireless.qcwatch.ui.home.sport.SportDetailCalorieActivity$$ExternalSyntheticLambda2
            ...
            public final void onChanged(Object obj) {
                SportDetailCalorieActivity.m828setupViews$lambda1(this.f$0, (HeartActivityViewModel.UserAge) obj);
            }
        });
        getDetailViewModel().getUi().observe(sportDetailCalorieActivity, new Observer() { // from class: com.qcwireless.qcwatch.ui.home.sport.SportDetailCalorieActivity$$ExternalSyntheticLambda1
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                SportDetailCalorieActivity.m829setupViews$lambda4(this.f$0, (SportPlusDetail) obj);
            }
        });
        ActivitySportDetailCalorieBinding activitySportDetailCalorieBinding7 = this.binding;
        if (activitySportDetailCalorieBinding7 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
        } else {
            activitySportDetailCalorieBinding = activitySportDetailCalorieBinding7;
        }
        activitySportDetailCalorieBinding.tvDesc.setOnClickListener(new View.OnClickListener() { // from class: com.qcwireless.qcwatch.ui.home.sport.SportDetailCalorieActivity$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                SportDetailCalorieActivity.m830setupViews$lambda5(this.f$0, view);
            }
        });
    }
    ...
    public static final void m828setupViews$lambda1(SportDetailCalorieActivity this$0, HeartActivityViewModel.UserAge userAge) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        int age = userAge.getAge();
        this$0.userAge = age;
        this$0.maxHeart = 220 - age;
        XLog.i(this$0.maxHeart + "--" + this$0.userAge);
        this$0.getDetailViewModel().querySportDetail(this$0.sportType, this$0.sportStartTime);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setupViews$lambda-4, reason: not valid java name */
    public static final void m829setupViews$lambda4(SportDetailCalorieActivity this$0, SportPlusDetail sportPlusDetail) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        ActivitySportDetailCalorieBinding activitySportDetailCalorieBinding = this$0.binding;
        ActivitySportDetailCalorieBinding activitySportDetailCalorieBinding2 = null;
        if (activitySportDetailCalorieBinding == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
            activitySportDetailCalorieBinding = null;
        }
        XLog.i(sportPlusDetail);
        ...
        if (!arrayList2.isEmpty()) {
            ...
            if (activitySportDetailCalorieBinding3 == null) {
                ...
                activitySportDetailCalorieBinding2 = activitySportDetailCalorieBinding3;
            }
            activitySportDetailCalorieBinding2.sportDetailHeartLine.setData(sportPlusDetail.getStartTime(), sportPlusDetail.getStartTime() + sportPlusDetail.getDuration(), arrayList);
        } else {
            ActivitySportDetailCalorieBinding activitySportDetailCalorieBinding4 = this$0.binding;
            if (activitySportDetailCalorieBinding4 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("binding");
            } else {
                activitySportDetailCalorieBinding2 = activitySportDetailCalorieBinding4;
            }
            activitySportDetailCalorieBinding2.sportDetailHeartLine.setData(0L, 0L, arrayList);
        }
        if (!arrayList2.isEmpty()) {
            int[] iArr = {0, 0, 0, 0, 0};
    ...
    public static final void m830setupViews$lambda5(SportDetailCalorieActivity this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
