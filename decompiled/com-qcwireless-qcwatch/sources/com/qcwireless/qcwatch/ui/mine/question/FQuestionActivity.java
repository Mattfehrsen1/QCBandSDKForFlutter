...
@Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\bH\u0014J\b\u0010\t\u001a\u00020\u0006H\u0015R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082.¢\u0006\u0002\n\u0000¨\u0006\n"}, d2 = {"Lcom/qcwireless/qcwatch/ui/mine/question/FQuestionActivity;", "Lcom/qcwireless/qcwatch/ui/base/BaseActivity;", "()V", "binding", "Lcom/qcwireless/qcwatch/databinding/ActivityWebBinding;", "onCreate", "", "savedInstanceState", "Landroid/os/Bundle;", "setupViews", "app_qwatch_proRelease"}, k = 1, mv = {1, 6, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FQuestionActivity extends BaseActivity {
    ...
    protected void setupViews() {
        ...
        activityWebBinding.titleBar.tvTitle.setText(getString(R.string.qc_text_102));
        ...
        activityWebBinding2.webView.setWebChromeClient(new WebChromeClient() { // from class: com.qcwireless.qcwatch.ui.mine.question.FQuestionActivity.setupViews.1
            @Override // android.webkit.WebChromeClient
            public void onProgressChanged(WebView view, int newProgress) {
                try {
                    if (newProgress == 100) {
                        if (FQuestionActivity.this.getActivity() != null) {
                            FQuestionActivity.this.dismissLoadingDialog();
                        }
                    } else if (FQuestionActivity.this.getActivity() != null) {
                        FQuestionActivity.this.showLoadingDialog();
                    }
