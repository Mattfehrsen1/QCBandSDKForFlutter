...
public class EbookSortComparator implements Comparator {
    private int compareCallNum = 0;

    @Override // java.util.Comparator
    public int compare(Object o1, Object o2) {
        Ebook ebook = (Ebook) o1;
        if (ebook.getFirstName().equals("#") && !((Ebook) o2).getFirstName().equals("#")) {
            return 1;
        }
        if (ebook.getFirstName().equals("#") || !((Ebook) o2).getFirstName().equals("#")) {
            return ebook.getFirstName().compareToIgnoreCase(((Ebook) o2).getFirstName());
        }
        return -1;
    }
