...
public class MusicSortComparator implements Comparator {
    private int compareCallNum = 0;

    @Override // java.util.Comparator
    public int compare(Object o1, Object o2) {
        Song song = (Song) o1;
        if (song.getFirstName().equals("#") && !((Song) o2).getFirstName().equals("#")) {
            return 1;
        }
        if (song.getFirstName().equals("#") || !((Song) o2).getFirstName().equals("#")) {
            return song.getFirstName().compareToIgnoreCase(((Song) o2).getFirstName());
        }
        return -1;
    }
