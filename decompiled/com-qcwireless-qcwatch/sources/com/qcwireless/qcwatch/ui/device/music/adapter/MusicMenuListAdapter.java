...
public final class MusicMenuListAdapter extends BaseQuickAdapter<MenuSongBean, BaseViewHolder> {
    private final MutableLiveData<Integer> _deletePosition;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MusicMenuListAdapter(Context context) {
        super(R.layout.recycleview_item_music_menu, null, 2, null);
    ...
    public void convert(BaseViewHolder holder, MenuSongBean item) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        Intrinsics.checkNotNullParameter(item, "item");
        TextView textView = (TextView) holder.getView(R.id.tv_menu_name);
        TextView textView2 = (TextView) holder.getView(R.id.tv_song_count);
        textView.setText(item.getMenuName());
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        String str = String.format(GlobalKt.getString(R.string.qc_text_541), Arrays.copyOf(new Object[]{Integer.valueOf(item.getSongCounts())}, 1));
