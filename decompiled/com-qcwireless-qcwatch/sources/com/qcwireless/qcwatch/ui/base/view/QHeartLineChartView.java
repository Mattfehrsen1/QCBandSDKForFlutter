...
public class QHeartLineChartView extends BaseChartView {
    int[] colors;
    int[] colorsLine;
    ...
    public QHeartLineChartView(Context context) {
        super(context);
        this.xMax = 1440;
        this.yMax = 240;
    ...
    public QHeartLineChartView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.xMax = 1440;
        this.yMax = 240;
        this.timeArray = new int[288];
    ...
    public QHeartLineChartView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public QHeartLineChartView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.currBean != null) {
            ...
            this.dotPaint.setColor(ContextCompat.getColor(this.context, R.color.q_view_heart_2));
    ...
    private void filterData(List<HeartDataBean> list, boolean today) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            ...
            } else if (list.get(i2).getMin() - list.get(i2 - 1).getMin() > heartDataBean.range) {
                heartDataBean.setBegin(true);
            }
