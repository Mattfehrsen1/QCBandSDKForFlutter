...
public class DeviceClassicsHeader extends ClassicsAbstract<DeviceClassicsHeader> implements RefreshHeader {
    public static final int ID_TEXT_UPDATE = 2131297364;
    ...
    public DeviceClassicsHeader(Context context) {
        this(context, null);
        this.mContext = context;
    }

    public DeviceClassicsHeader(Context context, AttributeSet attrs) {
        ...
        new ConstraintLayout.LayoutParams(-2, -2).topMargin = typedArrayObtainStyledAttributes.getDimensionPixelSize(20, SmartUtil.dp2px(0.0f));
        ...
        this.mShared = context.getSharedPreferences("DeviceClassicsHeader", 0);
        setLastUpdateTime(new Date(this.mShared.getLong(this.KEY_LAST_UPDATE_TIME, System.currentTimeMillis())));
    }

    @Override // com.qcwireless.qcwatch.ui.base.view.pullrefresh.ClassicsAbstract, com.scwang.smart.refresh.layout.simple.SimpleComponent, com.scwang.smart.refresh.layout.api.RefreshComponent
    ...
    public void onStateChanged(RefreshLayout refreshLayout, RefreshState oldState, RefreshState newState) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$scwang$smart$refresh$layout$constant$RefreshState[newState.ordinal()]) {
            case 1:
                textView.setVisibility(this.mEnableLastTime ? 0 : 8);
                break;
            case 2:
    ...
    /* renamed from: com.qcwireless.qcwatch.ui.base.view.pullrefresh.DeviceClassicsHeader$1, reason: invalid class name */
    ...
    public DeviceClassicsHeader setLastUpdateTime(Date time) {
        this.mLastTime = time;
        this.mLastUpdateText.setText(this.mContext.getString(R.string.srl_header_update, new DateUtil(time).getMMdd_HHmmDate()));
    ...
    public long getLastUpdateTime() {
        SharedPreferences sharedPreferences = this.mContext.getSharedPreferences("DeviceClassicsHeader", 0);
        this.mShared = sharedPreferences;
        return sharedPreferences.getLong(this.KEY_LAST_UPDATE_TIME, 0L);
    }

    public DeviceClassicsHeader setLastUpdateText(CharSequence text) {
        this.mLastTime = null;
    ...
    public DeviceClassicsHeader setAccentColor(int accentColor) {
        this.mLastUpdateText.setTextColor((16777215 & accentColor) | (-872415232));
        return (DeviceClassicsHeader) super.setAccentColor(accentColor);
    }

    public DeviceClassicsHeader setEnableLastTime(boolean enable) {
        TextView textView = this.mLastUpdateText;
    ...
    public DeviceClassicsHeader setTextSizeTime(float size) {
    ...
    public DeviceClassicsHeader setTextSizeTime(int unit, float size) {
    ...
    public DeviceClassicsHeader setTextTimeMarginTop(float dp) {
        TextView textView = this.mLastUpdateText;
    ...
    public DeviceClassicsHeader setTextTimeMarginTopPx(int px) {
