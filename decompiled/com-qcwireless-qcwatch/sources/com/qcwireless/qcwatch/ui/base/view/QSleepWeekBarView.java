...
public class QSleepWeekBarView extends BaseChartView {
    ...
    public QSleepWeekBarView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public QSleepWeekBarView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int i = (this.width - (this.leftRightOffset * 2)) / 6;
        for (int i2 = 0; i2 < this.data.size(); i2++) {
            SleepDataBean sleepDataBean = this.data.get(i2);
            ...
            int i3 = i2 * i;
            canvas.drawLine(this.leftRightOffset + i3, this.lineHeight - this.bottomOffset, this.leftRightOffset + i3, (this.lineHeight - this.bottomOffset) - deepScale, this.sleepPaint);
            this.sleepPaint.setColor(ContextCompat.getColor(this.context, R.color.q_view_sleep_2));
            canvas.drawLine(this.leftRightOffset + i3, (this.lineHeight - this.bottomOffset) - deepScale, this.leftRightOffset + i3, ((this.lineHeight - this.bottomOffset) - deepScale) - lightScale, this.sleepPaint);
            this.sleepPaint.setColor(ContextCompat.getColor(this.context, R.color.q_view_sleep_6));
            canvas.drawLine(this.leftRightOffset + i3, ((this.lineHeight - this.bottomOffset) - deepScale) - lightScale, this.leftRightOffset + i3, (((this.lineHeight - this.bottomOffset) - deepScale) - lightScale) - rapidScale, this.sleepPaint);
            this.sleepPaint.setColor(ContextCompat.getColor(this.context, R.color.q_view_sleep_3));
            canvas.drawLine(this.leftRightOffset + i3, (((this.lineHeight - this.bottomOffset) - deepScale) - lightScale) - rapidScale, this.leftRightOffset + i3, ((((this.lineHeight - this.bottomOffset) - deepScale) - lightScale) - rapidScale) - awakeScale, this.sleepPaint);
        }
    ...
    public void initPaint(Context context, AttributeSet attrs) {
        ...
        this.sleepPaint.setStrokeWidth(22.0f);
        initAttr(context, attrs);
    }

    public void initXLabel(List<SleepDataBean> data) {
        int i = (this.width - (this.leftRightOffset * 2)) / 6;
        ...
        for (int i2 = 0; i2 < data.size(); i2++) {
            if (i2 % 2 == 0) {
                ...
                if (i2 == 0) {
                    ...
                    xTextChange.setMin(this.leftRightOffset + ((i2 - 1) * i));
                    xTextChange.setMax(this.leftRightOffset + ((i2 + 1) * i));
                }
    ...
    public void setData(List<SleepDataBean> data) {
        ...
        this.fingerXDefault = this.leftRightOffset + ((r9.get(7) - 1) * i);
