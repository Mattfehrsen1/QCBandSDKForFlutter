...
public class QProgressCircle extends View {
    ...
    public QProgressCircle(Context context) {
        this(context, null);
        this.context = context;
    }

    public QProgressCircle(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        this.context = context;
    }

    public QProgressCircle(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        paint.setColor(ContextCompat.getColor(this.context, R.color.q_view_progress_bar));
        ...
        paint2.setColor(SkinCompatResources.getColor(this.context, R.color.color_FF6A00));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.radius = ((Math.max(this.width, this.height) - 40) - ((int) dp2px(this.context, 14.0f))) / 2;
        postInvalidate();
    }
