...
public final class QSettingItemWithClick extends SkinCompatConstraintLayout implements SkinCompatSupportable {
    ...
    private OnLSettingItemWithClick mOnLSettingItemClick;
    private Drawable mRightIcon;
    private int mRightIconId;
    private AppCompatCheckBox mRightIcon_check;
    private QSwitchView mRightIcon_switch;
    ...
    /* compiled from: QSettingItemWithClick.kt */
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0000\bf\u0018\u00002\u00020\u0001J\u0018\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H&¨\u0006\b"}, d2 = {"Lcom/qcwireless/qcwatch/ui/base/view/QSettingItemWithClick$OnLSettingItemWithClick;", "", "click", "", BreakpointSQLiteKey.ID, "", "isChecked", "", "app_qwatch_proRelease"}, k = 1, mv = {1, 6, 0}, xi = 48)
    public interface OnLSettingItemWithClick {
        void click(int id, boolean isChecked);
    }

    public final void setmOnLSettingItemWithClick(OnLSettingItemWithClick mOnLSettingItemClick) {
        this.mOnLSettingItemClick = mOnLSettingItemClick;
    }

    public final void setQSettingItemCheckListener(QSwitchView.OnSwitchStateChangeListener mOnCheckChangeListener) {
        Intrinsics.checkNotNullParameter(mOnCheckChangeListener, "mOnCheckChangeListener");
        QSwitchView qSwitchView = this.mRightIcon_switch;
        Intrinsics.checkNotNull(qSwitchView);
        qSwitchView.setOnSwitchStateChangeListener(mOnCheckChangeListener);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QSettingItemWithClick(Context context) {
        super(context);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QSettingItemWithClick(Context context, AttributeSet attributeSet) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QSettingItemWithClick(Context context, AttributeSet attributeSet, int i) {
    ...
    public final void getCustomStyle(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (index) {
                ...
                case 7:
                    this.mLeftIcon = typedArrayObtainStyledAttributes.getDrawable(index);
                ...
                case 9:
                    ...
                    TextView textView5 = this.mTvLeftSubText;
                ...
                case 11:
                    ...
                    TextView textView8 = this.mTvLeftText;
                ...
                case 14:
                    ...
                    textView9.setText(typedArrayObtainStyledAttributes.getString(index));
                    break;
                case 15:
                    ...
                    break;
                case 16:
                    this.mRightTextSize = typedArrayObtainStyledAttributes.getFloat(index, 14.0f);
        ...
        constraintLayout.setOnClickListener(new View.OnClickListener() { // from class: com.qcwireless.qcwatch.ui.base.view.QSettingItemWithClick$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                QSettingItemWithClick.m323getCustomStyle$lambda0(this.f$0, view2);
            }
        });
        AppCompatCheckBox appCompatCheckBox = this.mRightIcon_check;
        Intrinsics.checkNotNull(appCompatCheckBox);
        appCompatCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.qcwireless.qcwatch.ui.base.view.QSettingItemWithClick$$ExternalSyntheticLambda1
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                QSettingItemWithClick.m324getCustomStyle$lambda1(this.f$0, compoundButton, z);
            }
        });
    ...
    public static final void m323getCustomStyle$lambda0(QSettingItemWithClick this$0, View view) {
    ...
    public static final void m324getCustomStyle$lambda1(QSettingItemWithClick this$0, CompoundButton compoundButton, boolean z) {
        OnLSettingItemWithClick onLSettingItemWithClick;
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (compoundButton.isPressed() && (onLSettingItemWithClick = this$0.mOnLSettingItemClick) != null) {
            Intrinsics.checkNotNull(onLSettingItemWithClick);
    ...
    private final void switchRightStyle(int mRightStyle) {
        ...
        if (mRightStyle == 2) {
            ...
            QSwitchView qSwitchView2 = this.mRightIcon_switch;
            Intrinsics.checkNotNull(qSwitchView2);
        ...
        QSwitchView qSwitchView3 = this.mRightIcon_switch;
        Intrinsics.checkNotNull(qSwitchView3);
        qSwitchView3.setVisibility(0);
    }

    private final void initView(Context context) {
        View viewInflate = SkinCompatConstraintLayout.inflate(context, R.layout.qc_device_item_with_click, this);
        Intrinsics.checkNotNullExpressionValue(viewInflate, "inflate(context, R.layou…ce_item_with_click, this)");
        ...
        this.mRightIcon_switch = (QSwitchView) viewInflate.findViewById(R.id.rightswitch);
    ...
    private final void clickOn(int id) {
        ...
        if (i == 0 || i == 1) {
            OnLSettingItemWithClick onLSettingItemWithClick2 = this.mOnLSettingItemClick;
            if (onLSettingItemWithClick2 != null) {
                Intrinsics.checkNotNull(onLSettingItemWithClick2);
    ...
    public final void setLeftIcon(Drawable drawable) {
        ...
        RequestBuilder requestBuilderOverride = Glide.with(getContext()).load(drawable).override(90, 90);
        ImageView imageView = this.mIvLeftIcon;
        Intrinsics.checkNotNull(imageView);
        requestBuilderOverride.into(imageView);
        ViewKt.visible(this.mIvLeftIcon);
    }
