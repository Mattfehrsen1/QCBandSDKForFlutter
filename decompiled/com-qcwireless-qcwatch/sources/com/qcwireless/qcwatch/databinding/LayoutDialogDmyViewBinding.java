...
public final class LayoutDialogDmyViewBinding implements ViewBinding {
    ...
    private LayoutDialogDmyViewBinding(ConstraintLayout rootView, TextView tvDialogCancel, TextView tvDialogConfirm, TextView tvDialogTitle, WheelView wheelViewDay, WheelView wheelViewMonth, WheelView wheelViewYear) {
    ...
    public static LayoutDialogDmyViewBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LayoutDialogDmyViewBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.layout_dialog_dmy_view, parent, false);
        if (attachToParent) {
    ...
    public static LayoutDialogDmyViewBinding bind(View rootView) {
                ...
                if (textView3 != null) {
                    ...
                    if (wheelView != null) {
                        ...
                        if (wheelView2 != null) {
                            ...
                            if (wheelView3 != null) {
                                return new LayoutDialogDmyViewBinding((ConstraintLayout) rootView, textView, textView2, textView3, wheelView, wheelView2, wheelView3);
                            }
                        }
                    }
                }
