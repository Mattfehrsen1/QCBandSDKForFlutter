...
public final class FragmentWeekStepBinding implements ViewBinding {
    ...
    public final QStepWeekHistoryBarChart weekStepBarView;

    private FragmentWeekStepBinding(ConstraintLayout rootView, QDateWeekSwitchView qcDateChange, QStepComponentView stepAvg, QStepComponentView stepCalorie, QStepComponentView stepDistance, QStepComponentView stepTotal, TextView topBg1, TextView tvDayStep, TextView tvDayStepUnit, TextView tvStepRange, QStepWeekHistoryBarChart weekStepBarView) {
    ...
    public static FragmentWeekStepBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentWeekStepBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.fragment_week_step, parent, false);
        if (attachToParent) {
    ...
    public static FragmentWeekStepBinding bind(View rootView) {
                            ...
                            if (textView != null) {
                                ...
                                if (textView2 != null) {
                                    ...
                                    if (textView3 != null) {
                                        ...
                                        if (textView4 != null) {
                                            i = R.id.week_step_bar_view;
                                            QStepWeekHistoryBarChart qStepWeekHistoryBarChart = (QStepWeekHistoryBarChart) ViewBindings.findChildViewById(rootView, R.id.week_step_bar_view);
                                            if (qStepWeekHistoryBarChart != null) {
                                                return new FragmentWeekStepBinding((ConstraintLayout) rootView, qDateWeekSwitchView, qStepComponentView, qStepComponentView2, qStepComponentView3, qStepComponentView4, textView, textView2, textView3, textView4, qStepWeekHistoryBarChart);
                                            }
                                        }
                                    }
                                }
