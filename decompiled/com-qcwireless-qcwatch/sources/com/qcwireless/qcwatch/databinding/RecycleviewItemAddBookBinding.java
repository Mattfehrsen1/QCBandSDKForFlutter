...
public final class RecycleviewItemAddBookBinding implements ViewBinding {
    ...
    private RecycleviewItemAddBookBinding(ConstraintLayout rootView, ImageView imageSelect, View itemLine, TextView keyWord, TextView rcvDeviceAddress, TextView rcvDeviceName) {
    ...
    public static RecycleviewItemAddBookBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static RecycleviewItemAddBookBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.recycleview_item_add_book, parent, false);
        if (attachToParent) {
    ...
    public static RecycleviewItemAddBookBinding bind(View rootView) {
            ...
            if (viewFindChildViewById != null) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        ...
                        if (textView3 != null) {
                            return new RecycleviewItemAddBookBinding((ConstraintLayout) rootView, imageView, viewFindChildViewById, textView, textView2, textView3);
                        }
                    }
                }
            }
