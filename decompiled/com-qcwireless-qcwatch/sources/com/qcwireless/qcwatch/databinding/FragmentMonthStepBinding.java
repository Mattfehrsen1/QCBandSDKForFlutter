...
public final class FragmentMonthStepBinding implements ViewBinding {
    public final QStepMonthHistoryBarChart monthStepBarView;
    ...
    private FragmentMonthStepBinding(ConstraintLayout rootView, QStepMonthHistoryBarChart monthStepBarView, QDateMonthSwitchView qcDateChange, QStepComponentView stepAvg, QStepComponentView stepCalorie, QStepComponentView stepDistance, QStepComponentView stepTotal, TextView topBg1, TextView tvDayStep, TextView tvDayStepUnit, TextView tvStepRange) {
        this.rootView = rootView;
        this.monthStepBarView = monthStepBarView;
    ...
    public static FragmentMonthStepBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentMonthStepBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.fragment_month_step, parent, false);
        if (attachToParent) {
    ...
    public static FragmentMonthStepBinding bind(View rootView) {
        int i = R.id.month_step_bar_view;
        QStepMonthHistoryBarChart qStepMonthHistoryBarChart = (QStepMonthHistoryBarChart) ViewBindings.findChildViewById(rootView, R.id.month_step_bar_view);
        if (qStepMonthHistoryBarChart != null) {
                                ...
                                if (textView != null) {
                                    ...
                                    if (textView2 != null) {
                                        ...
                                        if (textView3 != null) {
                                            ...
                                            if (textView4 != null) {
                                                return new FragmentMonthStepBinding((ConstraintLayout) rootView, qStepMonthHistoryBarChart, qDateMonthSwitchView, qStepComponentView, qStepComponentView2, qStepComponentView3, qStepComponentView4, textView, textView2, textView3, textView4);
                                            }
                                        }
                                    }
                                }
