...
public final class ActivityStepBinding implements ViewBinding {
    ...
    private ActivityStepBinding(ConstraintLayout rootView, View statusBarView, FrameLayout stepContainer, QSwitchButtonView stepQsvView, LayoutTitleBarBinding titleBar) {
    ...
    public static ActivityStepBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityStepBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_step, parent, false);
        if (attachToParent) {
    ...
    public static ActivityStepBinding bind(View rootView) {
            ...
            if (frameLayout != null) {
                ...
                if (qSwitchButtonView != null) {
                    ...
                    if (viewFindChildViewById2 != null) {
                        return new ActivityStepBinding((ConstraintLayout) rootView, viewFindChildViewById, frameLayout, qSwitchButtonView, LayoutTitleBarBinding.bind(viewFindChildViewById2));
                    }
                }
            }
        }
