...
public final class RecycleviewItemManagerRecordBinding implements ViewBinding {
    ...
    private RecycleviewItemManagerRecordBinding(ConstraintLayout rootView, ImageView imageShowPop, View itemLine, TextView rcvDeviceAddress, TextView rcvDeviceName) {
    ...
    public static RecycleviewItemManagerRecordBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static RecycleviewItemManagerRecordBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.recycleview_item_manager_record, parent, false);
        if (attachToParent) {
    ...
    public static RecycleviewItemManagerRecordBinding bind(View rootView) {
        ...
        if (imageView != null) {
            ...
            if (viewFindChildViewById != null) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        return new RecycleviewItemManagerRecordBinding((ConstraintLayout) rootView, imageView, viewFindChildViewById, textView, textView2);
                    }
                }
            }
        }
