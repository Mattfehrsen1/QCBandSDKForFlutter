...
public final class RecycleviewItemPressureBinding implements ViewBinding {
    ...
    public final QPressureLineChartHomeView homeHeartView;
    public final ImageView imageNoData;
    private final ConstraintLayout rootView;

    private RecycleviewItemPressureBinding(ConstraintLayout rootView, TextView homeHeartDate, TextView homeHeartTitle, TextView homeHeartUnit, TextView homeHeartValue, QPressureLineChartHomeView homeHeartView, ImageView imageNoData) {
    ...
    public static RecycleviewItemPressureBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static RecycleviewItemPressureBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.recycleview_item_pressure, parent, false);
        if (attachToParent) {
    ...
    public static RecycleviewItemPressureBinding bind(View rootView) {
            ...
            if (textView2 != null) {
                ...
                if (textView3 != null) {
                    ...
                    if (textView4 != null) {
                        ...
                        QPressureLineChartHomeView qPressureLineChartHomeView = (QPressureLineChartHomeView) ViewBindings.findChildViewById(rootView, R.id.home_heart_view);
                        if (qPressureLineChartHomeView != null) {
                            ...
                            if (imageView != null) {
                                return new RecycleviewItemPressureBinding((ConstraintLayout) rootView, textView, textView2, textView3, textView4, qPressureLineChartHomeView, imageView);
                            }
                        }
                    }
                }
