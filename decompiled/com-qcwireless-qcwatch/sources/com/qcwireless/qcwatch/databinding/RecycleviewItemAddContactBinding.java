...
public final class RecycleviewItemAddContactBinding implements ViewBinding {
    ...
    private RecycleviewItemAddContactBinding(ConstraintLayout rootView, ImageView imageSelect, View itemLine, TextView keyWord, TextView rcvDeviceAddress, TextView rcvDeviceName) {
    ...
    public static RecycleviewItemAddContactBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static RecycleviewItemAddContactBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.recycleview_item_add_contact, parent, false);
        if (attachToParent) {
    ...
    public static RecycleviewItemAddContactBinding bind(View rootView) {
            ...
            if (viewFindChildViewById != null) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        ...
                        if (textView3 != null) {
                            return new RecycleviewItemAddContactBinding((ConstraintLayout) rootView, imageView, viewFindChildViewById, textView, textView2, textView3);
                        }
                    }
                }
            }
