...
public final class FragmentDayPressureBinding implements ViewBinding {
    ...
    public final QPressureBarChart qcPressureChart;
    public final QSettingItemTitleSubTitleSystem qcSettingPressure;
    public final LinearLayout rcvDetailLayout;
    public final RecyclerView rcvPressureDetail;
    ...
    private FragmentDayPressureBinding(NestedScrollView rootView, Button btnMeasure, ConstraintLayout cslHeartPie, View cstLine1, View cstLine2, ConstraintLayout ctlData, ConstraintLayout currHeartCtl, LinearLayout detailLayout, QCirclePieView heartCircleView, QSettingItem heartValueDetail, ImageView imageHeart, LinearLayout layout1, View line1, QStepComponentView pressureAvg, QStepComponentView pressureTotal, QDateSwitchView qcDateChange, QPressureBarChart qcPressureChart, QSettingItemTitleSubTitleSystem qcSettingPressure, LinearLayout rcvDetailLayout, RecyclerView rcvPressureDetail, TextView topBg1, TextView tv1, TextView tv11, TextView tv2, TextView tv22, TextView tv3, TextView tv4, TextView tv42, TextView tv5, TextView tv51, TextView tvAvg, TextView tvAvgValue, TextView tvChartTitle, TextView tvCurrHeart, TextView tvDayPressure, TextView tvDayPressureUnit, TextView tvHeart1, TextView tvHeartTime, TextView tvListDetail, TextView tvMax, TextView tvMaxValue, TextView tvMin, TextView tvMinValue, TextView tvNoData, TextView tvPressureRange, TextView tvValue1, TextView tvValue2, TextView tvValue3, TextView tvValue4, TextView tvValue5) {
    ...
    public static FragmentDayPressureBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentDayPressureBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.fragment_day_pressure, parent, false);
        if (attachToParent) {
    ...
    public static FragmentDayPressureBinding bind(View rootView) {
                                                        ...
                                                        if (qStepComponentView != null) {
                                                            ...
                                                            if (qStepComponentView2 != null) {
                                                                ...
                                                                if (qDateSwitchView != null) {
                                                                    ...
                                                                    QPressureBarChart qPressureBarChart = (QPressureBarChart) ViewBindings.findChildViewById(rootView, R.id.qc_pressure_chart);
                                                                    if (qPressureBarChart != null) {
                                                                        i = R.id.qc_setting_pressure;
                                                                        QSettingItemTitleSubTitleSystem qSettingItemTitleSubTitleSystem = (QSettingItemTitleSubTitleSystem) ViewBindings.findChildViewById(rootView, R.id.qc_setting_pressure);
                                                                        if (qSettingItemTitleSubTitleSystem != null) {
                                                                            ...
                                                                            if (linearLayout3 != null) {
                                                                                i = R.id.rcv_pressure_detail;
                                                                                RecyclerView recyclerView = (RecyclerView) ViewBindings.findChildViewById(rootView, R.id.rcv_pressure_detail);
                                                                                                                                ...
                                                                                                                                if (textView12 != null) {
                                                                                                                                    ...
                                                                                                                                    if (textView13 != null) {
                                                                                                                                        ...
                                                                                                                                        if (textView14 != null) {
                                                                                                                                            ...
                                                                                                                                            TextView textView15 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_day_pressure);
                                                                                                                                            if (textView15 != null) {
                                                                                                                                                i = R.id.tv_day_pressure_unit;
                                                                                                                                                TextView textView16 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_day_pressure_unit);
                                                                                                                                                if (textView16 != null) {
                                                                                                                                                    i = R.id.tv_heart_1;
                                                                                                                                                    ...
                                                                                                                                                    if (textView17 != null) {
                                                                                                                                                        ...
                                                                                                                                                        if (textView18 != null) {
                                                                                                                                                            ...
                                                                                                                                                            TextView textView19 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_list_detail);
                                                                                                                                                            if (textView19 != null) {
                                                                                                                                                                i = R.id.tv_max;
                                                                                                                                                                TextView textView20 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_max);
                                                                                                                                                                if (textView20 != null) {
                                                                                                                                                                    i = R.id.tv_max_value;
                                                                                                                                                                    TextView textView21 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_max_value);
                                                                                                                                                                    if (textView21 != null) {
                                                                                                                                                                        i = R.id.tv_min;
                                                                                                                                                                        TextView textView22 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_min);
                                                                                                                                                                        if (textView22 != null) {
                                                                                                                                                                            i = R.id.tv_min_value;
                                                                                                                                                                            TextView textView23 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_min_value);
                                                                                                                                                                            if (textView23 != null) {
                                                                                                                                                                                i = R.id.tv_no_data;
                                                                                                                                                                                TextView textView24 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_no_data);
                                                                                                                                                                                if (textView24 != null) {
                                                                                                                                                                                    i = R.id.tv_pressure_range;
                                                                                                                                                                                    TextView textView25 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_pressure_range);
                                                                                                                                                                                    if (textView25 != null) {
                                                                                                                                                                                        i = R.id.tv_value_1;
                                                                                                                                                                                            ...
                                                                                                                                                                                            if (textView27 != null) {
                                                                                                                                                                                                ...
                                                                                                                                                                                                if (textView28 != null) {
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    if (textView29 != null) {
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        if (textView30 != null) {
                                                                                                                                                                                                            return new FragmentDayPressureBinding((NestedScrollView) rootView, button, constraintLayout, viewFindChildViewById, viewFindChildViewById2, constraintLayout2, constraintLayout3, linearLayout, qCirclePieView, qSettingItem, imageView, linearLayout2, viewFindChildViewById3, qStepComponentView, qStepComponentView2, qDateSwitchView, qPressureBarChart, qSettingItemTitleSubTitleSystem, linearLayout3, recyclerView, textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8, textView9, textView10, textView11, textView12, textView13, textView14, textView15, textView16, textView17, textView18, textView19, textView20, textView21, textView22, textView23, textView24, textView25, textView26, textView27, textView28, textView29, textView30);
                                                                                                                                                                                                        }
                                                                                                                                                                                                    }
                                                                                                                                                                                                }
                                                                                                                                                                                            }
