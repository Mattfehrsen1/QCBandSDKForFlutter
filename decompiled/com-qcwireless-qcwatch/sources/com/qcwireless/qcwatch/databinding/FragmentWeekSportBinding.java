...
public final class FragmentWeekSportBinding implements ViewBinding {
    ...
    private FragmentWeekSportBinding(NestedScrollView rootView, ImageView imageSportNoData, ConstraintLayout noDataLayout, QDateWeekSwitchView qcDateChange, RecyclerView sportDetailRcv, QSportItemView totalCal, QSportItemView totalDays, QSportItemView totalTimes, TextView tvRecent, TextView weekTotal) {
    ...
    public static FragmentWeekSportBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentWeekSportBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.fragment_week_sport, parent, false);
        if (attachToParent) {
    ...
    public static FragmentWeekSportBinding bind(View rootView) {
                        ...
                        if (qSportItemView != null) {
                            ...
                            if (qSportItemView2 != null) {
                                ...
                                if (qSportItemView3 != null) {
                                    i = R.id.tv_recent;
                                    TextView textView = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_recent);
                                    if (textView != null) {
                                        i = R.id.week_total;
                                        TextView textView2 = (TextView) ViewBindings.findChildViewById(rootView, R.id.week_total);
                                        if (textView2 != null) {
                                            return new FragmentWeekSportBinding((NestedScrollView) rootView, imageView, constraintLayout, qDateWeekSwitchView, recyclerView, qSportItemView, qSportItemView2, qSportItemView3, textView, textView2);
                                        }
                                    }
                                }
                            }
