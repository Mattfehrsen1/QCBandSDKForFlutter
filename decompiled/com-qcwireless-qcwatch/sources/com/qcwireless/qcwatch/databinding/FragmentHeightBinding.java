...
public final class FragmentHeightBinding implements ViewBinding {
    ...
    private FragmentHeightBinding(ConstraintLayout rootView, Button btnNext, ConstraintLayout ctsHeight, TextView tvCenter, TextView tvTitle, WheelView wheelView, WheelView wheelViewUnit) {
    ...
    public static FragmentHeightBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentHeightBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.fragment_height, parent, false);
        if (attachToParent) {
    ...
    public static FragmentHeightBinding bind(View rootView) {
        int i = R.id.btn_next;
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        ...
                        if (wheelView != null) {
                            ...
                            if (wheelView2 != null) {
                                return new FragmentHeightBinding((ConstraintLayout) rootView, button, constraintLayout, textView, textView2, wheelView, wheelView2);
                            }
                        }
                    }
                }
