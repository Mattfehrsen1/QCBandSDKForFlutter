...
public final class FragmentWallpaperMarketBinding implements ViewBinding {
    ...
    private FragmentWallpaperMarketBinding(ConstraintLayout rootView, Button btnAddDevice, Button btnTryAgain, ConstraintLayout ctlNoDevice, ConstraintLayout ctlNoNetwork, MyRecycleView dialCardRcv, TextView tvNoDeviceTitle, TextView tvNoNetwork) {
    ...
    public static FragmentWallpaperMarketBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentWallpaperMarketBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.fragment_wallpaper_market, parent, false);
        if (attachToParent) {
    ...
    public static FragmentWallpaperMarketBinding bind(View rootView) {
        ...
        if (button != null) {
            ...
            Button button2 = (Button) ViewBindings.findChildViewById(rootView, R.id.btn_try_again);
            if (button2 != null) {
                    ...
                    if (constraintLayout2 != null) {
                        ...
                        if (myRecycleView != null) {
                            ...
                            if (textView != null) {
                                ...
                                if (textView2 != null) {
                                    return new FragmentWallpaperMarketBinding((ConstraintLayout) rootView, button, button2, constraintLayout, constraintLayout2, myRecycleView, textView, textView2);
                                }
                            }
                        }
                    }
