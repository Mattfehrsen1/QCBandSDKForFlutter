...
public final class FragmentWeekPressureBinding implements ViewBinding {
    ...
    public final QPressureWeekHistoryBarChart qcPressureChart;
    ...
    private FragmentWeekPressureBinding(ConstraintLayout rootView, ConstraintLayout cslHeartPie, View cstLine1, View cstLine2, ConstraintLayout ctlData, QCirclePieView heartCircleView, QStepComponentView pressureAvg, QStepComponentView pressureTotal, QDateWeekSwitchView qcDateChange, QPressureWeekHistoryBarChart qcPressureChart, TextView topBg1, TextView tv1, TextView tv11, TextView tv2, TextView tv22, TextView tv3, TextView tv4, TextView tv42, TextView tv5, TextView tv51, TextView tvAvg, TextView tvAvgValue, TextView tvDayPressure, TextView tvDayPressureUnit, TextView tvMax, TextView tvMaxValue, TextView tvMin, TextView tvMinValue, TextView tvPressureRange, TextView tvValue1, TextView tvValue2, TextView tvValue3, TextView tvValue4, TextView tvValue5) {
    ...
    public static FragmentWeekPressureBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentWeekPressureBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.fragment_week_pressure, parent, false);
        if (attachToParent) {
    ...
    public static FragmentWeekPressureBinding bind(View rootView) {
                            ...
                            if (qStepComponentView != null) {
                                ...
                                if (qStepComponentView2 != null) {
                                    ...
                                    if (qDateWeekSwitchView != null) {
                                        ...
                                        QPressureWeekHistoryBarChart qPressureWeekHistoryBarChart = (QPressureWeekHistoryBarChart) ViewBindings.findChildViewById(rootView, R.id.qc_pressure_chart);
                                                                                                                            ...
                                                                                                                            if (textView21 != null) {
                                                                                                                                ...
                                                                                                                                if (textView22 != null) {
                                                                                                                                    ...
                                                                                                                                    if (textView23 != null) {
                                                                                                                                        ...
                                                                                                                                        if (textView24 != null) {
                                                                                                                                            return new FragmentWeekPressureBinding((ConstraintLayout) rootView, constraintLayout, viewFindChildViewById, viewFindChildViewById2, constraintLayout2, qCirclePieView, qStepComponentView, qStepComponentView2, qDateWeekSwitchView, qPressureWeekHistoryBarChart, textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8, textView9, textView10, textView11, textView12, textView13, textView14, textView15, textView16, textView17, textView18, textView19, textView20, textView21, textView22, textView23, textView24);
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                }
                                                                                                                            }
