...
public final class LayoutDialogBirthdayViewBinding implements ViewBinding {
    ...
    private LayoutDialogBirthdayViewBinding(ConstraintLayout rootView, TextView tvCenter, TextView tvDialogCancel, TextView tvDialogConfirm, TextView tvDialogTitle, WheelView wheelViewMonth, WheelView wheelViewYear) {
    ...
    public static LayoutDialogBirthdayViewBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LayoutDialogBirthdayViewBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.layout_dialog_birthday_view, parent, false);
        if (attachToParent) {
    ...
    public static LayoutDialogBirthdayViewBinding bind(View rootView) {
                ...
                if (textView3 != null) {
                    ...
                    if (textView4 != null) {
                        ...
                        if (wheelView != null) {
                            ...
                            if (wheelView2 != null) {
                                return new LayoutDialogBirthdayViewBinding((ConstraintLayout) rootView, textView, textView2, textView3, textView4, wheelView, wheelView2);
                            }
                        }
                    }
                }
