...
public final class ActivitySportDetailCalorieBinding implements ViewBinding {
    ...
    public final ConstraintLayout supportHeart;
    ...
    private ActivitySportDetailCalorieBinding(ConstraintLayout rootView, ConstraintLayout detailCtl1, QCirclePieView heartCircleView, View line1, QHeartSportDetailLineChartView sportDetailHeartLine, QSportDetailItem sportDurationTime, QSportDetailItem sportHeart, ConstraintLayout supportHeart, LayoutTitleBarBinding titleBar, TextView tv1, TextView tv2, TextView tv3, TextView tv4, TextView tv5, TextView tvDesc, TextView tvHeartMaxInfo, TextView tvHeartMaxValue, TextView tvHeartMinInfo, TextView tvHeartMinValue, TextView tvHeartTitle, TextView tvKcal, TextView tvKcalUnit, TextView tvSportName, TextView tvSportStartTime, TextView tvValue1, TextView tvValue2, TextView tvValue3, TextView tvValue4, TextView tvValue5) {
        ...
        this.supportHeart = supportHeart;
    ...
    public static ActivitySportDetailCalorieBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivitySportDetailCalorieBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_sport_detail_calorie, parent, false);
        if (attachToParent) {
    ...
    public static ActivitySportDetailCalorieBinding bind(View rootView) {
                    ...
                    if (qHeartSportDetailLineChartView != null) {
                        ...
                        if (qSportDetailItem != null) {
                            ...
                            if (qSportDetailItem2 != null) {
                                i = R.id.support_heart;
                                ConstraintLayout constraintLayout2 = (ConstraintLayout) ViewBindings.findChildViewById(rootView, R.id.support_heart);
                                                                                                        ...
                                                                                                        if (textView17 != null) {
                                                                                                            ...
                                                                                                            if (textView18 != null) {
                                                                                                                ...
                                                                                                                if (textView19 != null) {
                                                                                                                    ...
                                                                                                                    if (textView20 != null) {
                                                                                                                        return new ActivitySportDetailCalorieBinding((ConstraintLayout) rootView, constraintLayout, qCirclePieView, viewFindChildViewById, qHeartSportDetailLineChartView, qSportDetailItem, qSportDetailItem2, constraintLayout2, layoutTitleBarBindingBind, textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8, textView9, textView10, textView11, textView12, textView13, textView14, textView15, textView16, textView17, textView18, textView19, textView20);
                                                                                                                    }
                                                                                                                }
                                                                                                            }
                                                                                                        }
