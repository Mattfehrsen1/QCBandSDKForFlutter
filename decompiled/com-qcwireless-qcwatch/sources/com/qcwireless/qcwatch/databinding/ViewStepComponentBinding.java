...
public final class ViewStepComponentBinding implements ViewBinding {
    ...
    private ViewStepComponentBinding(ConstraintLayout rootView, TextView tv1, Group tvDetailGroup, TextView tvSleepHour, TextView tvSleepMin, TextView tvSleepStatus, TextView tvSleepTotalTime, TextView tvSleepUnitH, TextView tvSleepUnitMin) {
    ...
    public static ViewStepComponentBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ViewStepComponentBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.view_step_component, parent, false);
        if (attachToParent) {
    ...
    public static ViewStepComponentBinding bind(View rootView) {
        int i = R.id.tv_1;
                        ...
                        if (textView4 != null) {
                            ...
                            if (textView5 != null) {
                                ...
                                if (textView6 != null) {
                                    ...
                                    if (textView7 != null) {
                                        return new ViewStepComponentBinding((ConstraintLayout) rootView, textView, group, textView2, textView3, textView4, textView5, textView6, textView7);
                                    }
                                }
                            }
                        }
