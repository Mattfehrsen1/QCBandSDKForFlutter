...
public final class AnimatorSet extends Animator {
    ...
    public AnimatorSet mo236clone() {
        ...
        while (it.hasNext()) {
            Node next = it.next();
            Node nodeM237clone = next.m237clone();
            map.put(next, nodeM237clone);
            animatorSet.mNodes.add(nodeM237clone);
            animatorSet.mNodeMap.put(nodeM237clone.animation, nodeM237clone);
            ArrayList arrayList = null;
            nodeM237clone.dependencies = null;
            nodeM237clone.tmpDependencies = null;
            nodeM237clone.nodeDependents = null;
            nodeM237clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = nodeM237clone.animation.getListeners();
            if (listeners != null) {
    ...
    private static class Node implements Cloneable {
        ...
        public Node m237clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo236clone();
                return node;
