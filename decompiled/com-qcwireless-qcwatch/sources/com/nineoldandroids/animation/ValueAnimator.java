    ...
    public ValueAnimator mo236clone() {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder propertyValuesHolderMo240clone = propertyValuesHolderArr[i2].mo240clone();
                valueAnimator.mValues[i2] = propertyValuesHolderMo240clone;
                valueAnimator.mValuesMap.put(propertyValuesHolderMo240clone.getPropertyName(), propertyValuesHolderMo240clone);
            }
        }
        return valueAnimator;
    }
