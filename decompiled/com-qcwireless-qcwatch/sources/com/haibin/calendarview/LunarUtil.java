...
public final class LunarUtil {
    ...
    private static int[] solarFromInt(long j) {
        ...
        long j5 = 2 + j4;
        return new int[]{(int) (j2 + (j5 / 12)), (int) ((j5 % 12) + 1), (int) ((j3 - (((j4 * 306) + 5) / 10)) + 1), 0};
    }
    ...
    public static int[] solarToLunar(int i, int i2, int i3) {
        ...
        int i5 = iArr2[i4];
        long jSolarToInt = solarToInt(i, i2, i3) - solarToInt(getBitInt(i5, 12, 9), getBitInt(i5, 4, 5), getBitInt(i5, 5, 0));
