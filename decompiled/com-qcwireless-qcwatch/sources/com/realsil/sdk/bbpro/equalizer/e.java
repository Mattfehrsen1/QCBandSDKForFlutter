...
public class e extends ModelClient<EqModelCallback> {
    ...
    */
    public com.realsil.sdk.bbpro.equalizer.AudioEq decodeAudioEq(byte r16, byte[] r17, int r18) {
        ...
        L58:
            com.realsil.sdk.bbpro.DspConfig r2 = r15.getDspConfig()     // Catch: java.lang.Exception -> L93
            com.realsil.sdk.bbpro.DspConfig$SigProcEQ_T r2 = r2.parseEq(r10, r9)     // Catch: java.lang.Exception -> L93
        L60:
            int r3 = r2.StageNum     // Catch: java.lang.Exception -> L93
            if (r5 >= r3) goto L75
            double[] r3 = r2.Q     // Catch: java.lang.Exception -> L93
        ...
        L72:
            ...
            goto L60
        L75:
            com.realsil.sdk.bbpro.equalizer.AudioEq r14 = new com.realsil.sdk.bbpro.equalizer.AudioEq     // Catch: java.lang.Exception -> L93
            int r3 = r2.StageNum     // Catch: java.lang.Exception -> L93
            double r4 = r2.GlobalGain     // Catch: java.lang.Exception -> L93
            int r4 = r15.a(r4)     // Catch: java.lang.Exception -> L93
            double r4 = (double) r4     // Catch: java.lang.Exception -> L93
            int r7 = r2.Accuracy     // Catch: java.lang.Exception -> L93
            double[] r8 = r2.Freq     // Catch: java.lang.Exception -> L93
            double[] r9 = r2.Q     // Catch: java.lang.Exception -> L93
            double[] r10 = r2.Gain     // Catch: java.lang.Exception -> L93
            int[] r11 = r2.BiquadType     // Catch: java.lang.Exception -> L93
            r2 = r14
            r6 = r16
            r12 = r17
            r2.<init>(r3, r4, r6, r7, r8, r9, r10, r11, r12)     // Catch: java.lang.Exception -> L93
            return r14
        L93:
            r0 = move-exception
    ...
    public final boolean a(TransportLayerPacket transportLayerPacket) {
        ...
        switch (opcode) {
            ...
            case 516:
                ...
                return true;
            case 517:
                com.realsil.sdk.bbpro.c.b bVarA = com.realsil.sdk.bbpro.c.b.a(payload);
                if (bVarA != null) {
    ...
    public final boolean b(TransportLayerPacket transportLayerPacket) {
        ...
        if (opcode != 518) {
            if (opcode != 520) {
                if (opcode == 3585) {
                    int eqSpecVersion = getEqSpecVersion();
                    ZLogger.v(ModelClient.VDBG, String.format("eqSpecVersion=0x%04X", Integer.valueOf(eqSpecVersion)));
                    if (eqSpecVersion <= 3) {
                    ...
                    switch (opcode) {
                        ...
                        case 513:
                            ...
                            EqIndex eqIndex = EqIndex.parse(eqSpecVersion2, parameters);
                            if (eqIndex != null) {
                                if (eqSpecVersion2 == 2 || eqSpecVersion2 == 3 || eqSpecVersion2 == 4 || eqSpecVersion2 == 5) {
                                    eqIndex.audioEq = decodeAudioEq(eqIndex.sampleRate, eqIndex.eqData);
                                } else if ((eqSpecVersion2 == 256 || eqSpecVersion2 == 257 || eqSpecVersion2 >= 258) && (eqWrapperWrapperAudioEq = wrapperAudioEq(eqIndex.audioEq)) != null) {
    ...
    public final void a(byte[] bArr) {
        com.realsil.sdk.bbpro.c.a aVarA = com.realsil.sdk.bbpro.c.a.a(bArr);
        if (aVarA == null) {
            this.j = null;
            return;
        }
