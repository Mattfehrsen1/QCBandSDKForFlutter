...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM1105constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM1105constructorimpl = Result.m1105constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1105constructorimpl = Result.m1105constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m1108exceptionOrNullimpl(objM1105constructorimpl) == null) {
            obj2 = objM1105constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM1105constructorimpl2 = Result.m1105constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM1105constructorimpl2 = Result.m1105constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m1108exceptionOrNullimpl(objM1105constructorimpl2) == null) {
            obj = objM1105constructorimpl2;
        }
