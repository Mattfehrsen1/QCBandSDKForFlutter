...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2589scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2525delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2526toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2526toDelayMillisLRDsOJo(long j) {
        if (Duration.m2388compareToLRDsOJo(j, Duration.INSTANCE.m2491getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2407getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
