...
public final class TimeoutKt {
    ...
    public static final <T> Object m2535withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m2526toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    */
    public static final <T> java.lang.Object withTimeoutOrNull(long r7, kotlin.jvm.functions.Function2<? super kotlinx.coroutines.CoroutineScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r9, kotlin.coroutines.Continuation<? super T> r10) {
        ...
        L4a:
            ...
            r10.<init>()
            r0.L$0 = r9     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L75
            r0.L$1 = r10     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L75
            r0.J$0 = r7     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L75
            r0.label = r4     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L75
            r2 = r0
            kotlin.coroutines.Continuation r2 = (kotlin.coroutines.Continuation) r2     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L75
            kotlinx.coroutines.TimeoutCoroutine r4 = new kotlinx.coroutines.TimeoutCoroutine     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L75
            r4.<init>(r7, r2)     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L75
            r10.element = r4     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L75
            java.lang.Object r7 = setupTimeout(r4, r9)     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L75
            java.lang.Object r8 = kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L75
            if (r7 != r8) goto L70
            kotlin.coroutines.Continuation r0 = (kotlin.coroutines.Continuation) r0     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L75
            kotlin.coroutines.jvm.internal.DebugProbesKt.probeCoroutineSuspended(r0)     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L75
        L70:
            if (r7 != r1) goto L73
            return r1
        L73:
    ...
    public static final <T> Object m2536withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m2526toDelayMillisLRDsOJo(j), function2, continuation);
    }
