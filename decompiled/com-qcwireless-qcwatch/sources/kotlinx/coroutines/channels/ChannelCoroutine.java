...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2541receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2541receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2542tryReceivePtdJZtk() {
        return this._channel.mo2542tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2543trySendJP2dKIU(E element) {
        return this._channel.mo2543trySendJP2dKIU(element);
    }
