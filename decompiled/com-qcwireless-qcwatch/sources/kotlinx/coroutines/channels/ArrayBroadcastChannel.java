        ...
        */
        public final boolean checkOffer() {
            ...
            L3:
                ...
                goto L72
            L13:
                java.lang.Object r3 = r10.peekUnderLock()     // Catch: java.lang.Throwable -> L6b
                kotlinx.coroutines.internal.Symbol r5 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch: java.lang.Throwable -> L6b
                if (r3 != r5) goto L21
            L1b:
                java.util.concurrent.locks.ReentrantLock r3 = r10.subLock
                r3.unlock()
                goto L3
            L21:
                boolean r5 = r3 instanceof kotlinx.coroutines.channels.Closed     // Catch: java.lang.Throwable -> L6b
                if (r5 == 0) goto L2e
                r4 = r3
                kotlinx.coroutines.channels.Closed r4 = (kotlinx.coroutines.channels.Closed) r4     // Catch: java.lang.Throwable -> L6b
            L28:
                java.util.concurrent.locks.ReentrantLock r0 = r10.subLock
                r0.unlock()
                goto L72
            L2e:
                kotlinx.coroutines.channels.ReceiveOrClosed r5 = r10.takeFirstReceiveOrPeekClosed()     // Catch: java.lang.Throwable -> L6b
                if (r5 != 0) goto L35
                goto L28
            L35:
                boolean r6 = r5 instanceof kotlinx.coroutines.channels.Closed     // Catch: java.lang.Throwable -> L6b
                if (r6 == 0) goto L3a
                goto L28
            L3a:
                kotlinx.coroutines.internal.Symbol r4 = r5.tryResumeReceive(r3, r4)     // Catch: java.lang.Throwable -> L6b
                if (r4 != 0) goto L41
                goto L1b
            L41:
                boolean r2 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch: java.lang.Throwable -> L6b
                if (r2 == 0) goto L57
                kotlinx.coroutines.internal.Symbol r2 = kotlinx.coroutines.CancellableContinuationImplKt.RESUME_TOKEN     // Catch: java.lang.Throwable -> L6b
                if (r4 != r2) goto L4d
                r2 = 1
                goto L4e
            L4d:
            ...
            L57:
                long r6 = r10.get_subHead()     // Catch: java.lang.Throwable -> L6b
                r8 = 1
                long r6 = r6 + r8
                r10.setSubHead(r6)     // Catch: java.lang.Throwable -> L6b
