...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                ...
                objM1105constructorimpl = Result.m1105constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM1105constructorimpl = Result.m1105constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m2548boximpl(Result.m1112isSuccessimpl(objM1105constructorimpl) ? ChannelResult.INSTANCE.m2563successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2561closedJP2dKIU(Result.m1108exceptionOrNullimpl(objM1105constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2543trySendJP2dKIU = sendChannel.mo2543trySendJP2dKIU(e);
        if (objMo2543trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m2558isSuccessimpl(sendChannel.mo2543trySendJP2dKIU(e))) {
            return;
        }
