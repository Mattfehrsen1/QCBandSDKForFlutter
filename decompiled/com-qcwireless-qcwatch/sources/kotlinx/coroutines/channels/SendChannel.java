...
public interface SendChannel<E> {
    ...
    Object mo2543trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2558isSuccessimpl(objMo2543trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2552exceptionOrNullimpl = ChannelResult.m2552exceptionOrNullimpl(objMo2543trySendJP2dKIU);
