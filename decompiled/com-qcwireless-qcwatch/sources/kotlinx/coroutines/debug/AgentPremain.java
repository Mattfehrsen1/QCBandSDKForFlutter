...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM1105constructorimpl = Result.m1105constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1105constructorimpl = Result.m1105constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m1111isFailureimpl(objM1105constructorimpl) ? null : objM1105constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m2565installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m2565installSignalHandler$lambda1(Signal signal) {
