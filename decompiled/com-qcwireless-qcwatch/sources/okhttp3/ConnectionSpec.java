...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m2628deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m2630deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public int hashCode() {
        ...
        String[] strArr = this.cipherSuitesAsString;
        int iHashCode = (GattClient.STATE_PREPARED + (strArr != null ? Arrays.hashCode(strArr) : 0)) * 31;
