...
public final class Route {
    ...
    public int hashCode() {
        return ((((GattClient.STATE_PREPARED + this.address.hashCode()) * 31) + this.proxy.hashCode()) * 31) + this.socketAddress.hashCode();
    }
