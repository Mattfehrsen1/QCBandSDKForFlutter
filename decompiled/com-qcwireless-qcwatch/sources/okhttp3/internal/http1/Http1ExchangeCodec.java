...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    private final boolean isChunked(Response response) {
        return StringsKt.equals("chunked", Response.header$default(response, Util.TRANSFER_ENCODING, null, 2, null), true);
    }

    private final boolean isChunked(Request request) {
        return StringsKt.equals("chunked", request.header(Util.TRANSFER_ENCODING), true);
    }
    ...
    public Source openResponseBodySource(Response response) {
        ...
        long jHeadersContentLength = okhttp3.internal.Util.headersContentLength(response);
    ...
    public final void skipConnectBody(Response response) {
        ...
        okhttp3.internal.Util.skipAll(sourceNewFixedLengthSource, Integer.MAX_VALUE, TimeUnit.MILLISECONDS);
    ...
    private final class FixedLengthSource extends AbstractSource {
        ...
        public void close() {
            ...
            if (this.bytesRemaining != 0 && !okhttp3.internal.Util.discard(this, 100, TimeUnit.MILLISECONDS)) {
                Http1ExchangeCodec.this.getConnection().noNewExchanges$okhttp();
                responseBodyComplete();
            }
            setClosed(true);
    ...
    private final class ChunkedSource extends AbstractSource {
        ...
        public void close() {
            ...
            if (this.hasMoreChunks && !okhttp3.internal.Util.discard(this, 100, TimeUnit.MILLISECONDS)) {
                this.this$0.getConnection().noNewExchanges$okhttp();
                responseBodyComplete();
            }
            setClosed(true);
