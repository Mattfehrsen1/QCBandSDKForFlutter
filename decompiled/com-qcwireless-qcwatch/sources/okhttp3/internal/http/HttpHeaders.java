...
public final class HttpHeaders {
    ...
    */
    ...
    public static final boolean promisesBody(Response promisesBody) {
        ...
        if (Intrinsics.areEqual(promisesBody.request().method(), Util.METHOD_HEAD)) {
            return false;
        }
        int iCode = promisesBody.code();
        return (((iCode >= 100 && iCode < 200) || iCode == 204 || iCode == 304) && okhttp3.internal.Util.headersContentLength(promisesBody) == -1 && !StringsKt.equals("chunked", Response.header$default(promisesBody, Util.TRANSFER_ENCODING, null, 2, null), true)) ? false : true;
    }
