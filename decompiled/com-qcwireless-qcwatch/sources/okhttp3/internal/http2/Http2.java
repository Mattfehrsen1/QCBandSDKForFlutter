...
public final class Http2 {
    ...
    private static final String[] FRAME_NAMES = {BleAction.EXTRA_DATA, "HEADERS", "PRIORITY", "RST_STREAM", "SETTINGS", "PUSH_PROMISE", "PING", "GOAWAY", "WINDOW_UPDATE", "CONTINUATION"};
    ...
    static {
        ...
        for (int i4 = 0; i4 < 3; i4++) {
            ...
            for (int i6 = 0; i6 < 1; i6++) {
                ...
                int i8 = i7 | i5;
                strArr5[i8] = strArr5[i7] + LogUtils.VERTICAL + strArr5[i5];
                strArr5[i8 | 8] = strArr5[i7] + LogUtils.VERTICAL + strArr5[i5] + "|PADDED";
            }
        }
