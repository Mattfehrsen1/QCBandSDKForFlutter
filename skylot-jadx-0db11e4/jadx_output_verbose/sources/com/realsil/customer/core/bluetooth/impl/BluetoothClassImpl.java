...
/* loaded from: qc_sdk_20250409.aar:classes.jar:com/realsil/customer/core/bluetooth/impl/BluetoothClassImpl.class */
public class BluetoothClassImpl {
    ...
    /* loaded from: qc_sdk_20250409.aar:classes.jar:com/realsil/customer/core/bluetooth/impl/BluetoothClassImpl$Device.class */
    ...
    public static boolean isAudioDevice(BluetoothClass bluetoothClass) {
        ...
        switch (bluetoothClass.getDeviceClass()) {
            case EqConstants.CodeIndex.REALTIME_EQ_2 /* 1024 */:
            case 1028:
            case 1032:
            case 1040:
            case 1044:
    ...
    public static String parseDeviceClass(BluetoothClass bluetoothClass) {
        ...
        switch (bluetoothClass.getMajorDeviceClass()) {
            ...
            case EqConstants.CodeIndex.REALTIME_EQ_2 /* 1024 */:
                ...
                break;
            case Device.PERIPHERAL_NON_KEYBOARD_NON_POINTING /* 1280 */:
            ...
            case 1792:
                sb.append("WEARABLE");
                break;
            case EqConstants.CodeIndex.GAMING_MODE_EQ /* 2048 */:
                sb.append("TOY");
                break;
            case 2304:
                sb.append("HEALTH");
