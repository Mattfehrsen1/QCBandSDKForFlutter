...
/* loaded from: qc_sdk_20250409.aar:libs/rtk-audioconnect-localplayback-1.0.9.jar:com/realsil/customer/audioconnect/localplayback/LocalPlaybackModelClient.class */
public class LocalPlaybackModelClient extends ModelClient<LocalPlaybackModelCallback> {
    ...
    /* JADX WARN: Type inference failed for: r0v1, types: [java.lang.Class<com.realsil.customer.audioconnect.localplayback.LocalPlaybackModelClient>] */
    /* JADX WARN: Type inference failed for: r0v2, types: [java.lang.Throwable] */
    /* JADX WARN: Type inference failed for: r0v4 */
    public static void initialize(Context context) {
        if (a == null) {
            ?? r0 = LocalPlaybackModelClient.class;
            synchronized (r0) {
                if (a == null) {
    ...
    public boolean processEventPacket(TransportLayerPacket transportLayerPacket) {
        ...
        switch (opcode) {
            case 1664:
                ...
                bundle.putInt("com.realsil.android.extra.RWS_STATUS", b & 1);
                bundle.putInt("com.realsil.android.extra.BUD_ROLE", (b & 2) >> 1);
                bundle.putInt("com.realsil.android.extra.SUPPORT_FORMATS", i4);
            ...
            case 1665:
                ...
                if (b2 == 0) {
                    ...
                    int i5 = byteBufferWrap2.getShort(1) & 65535;
                    long j = byteBufferWrap2.getInt(3) & 4294967295L;
                    ZLogger.w(ModelClient.VDBG, "current file crc: " + i5 + ", total length: " + j);
                    ...
                    while (it2.hasNext()) {
                        ((LocalPlaybackModelCallback) it2.next()).onGetFileHeaderReport(i5, j);
                    }
                    return true;
                }
                if (b2 != 1 && b2 != 2) {
                ...
                int i6 = byteBufferWrap3.getShort(1) & 65535;
                ZLogger.w(ModelClient.VDBG, "current file length: " + i6);
                byte[] bArr = new byte[i6];
                System.arraycopy(parameters, 3, bArr, 0, i6);
                ...
                for (MCB mcb : this.mCallbacks) {
                    if (b2 == 1) {
                        mcb.onGetFileContentReport(i6, bArr);
                    } else {
                        mcb.onGetFileFooterReport(i6, bArr);
                    }
                }
                return true;
            case 1666:
                ...
                while (it3.hasNext()) {
                    ((LocalPlaybackModelCallback) it3.next()).onEnterSongTransferModeReport(i7 == 1);
                }
                return true;
            case 1667:
                if (parameters == null || parameters.length <= 0) {
            ...
            case 1668:
                ...
                while (it4.hasNext()) {
                    ((LocalPlaybackModelCallback) it4.next()).onTransferWasValidReport(i9);
                }
                return true;
            case 1669:
            case 1674:
            ...
            case 1670:
                ...
                while (it5.hasNext()) {
                    ((LocalPlaybackModelCallback) it5.next()).onCancelTransferReport(i10 == 1);
                }
                return true;
            case 1671:
                if (parameters == null || parameters.length <= 0) {
                ...
                while (it6.hasNext()) {
                    ((LocalPlaybackModelCallback) it6.next()).onExitSongTransferModeReport(i11 == 1);
                }
                return true;
            case 1672:
                if (parameters == null || parameters.length <= 0) {
                ...
                while (it7.hasNext()) {
                    ((LocalPlaybackModelCallback) it7.next()).onDeleteSingleSongReport(i12);
                }
                return true;
            case 1673:
                if (parameters == null || parameters.length <= 0) {
                ...
                while (it8.hasNext()) {
                    ((LocalPlaybackModelCallback) it8.next()).onAddOrDeleteSongToPlaylistReport(i13);
                }
                return true;
            case 1675:
                if (parameters == null || parameters.length <= 0) {
                ...
                while (it9.hasNext()) {
                    ((LocalPlaybackModelCallback) it9.next()).onDeleteAllSongReport(i14);
                }
                return true;
        }
    }
