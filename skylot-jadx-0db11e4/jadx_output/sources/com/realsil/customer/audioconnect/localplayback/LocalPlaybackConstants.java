...
/* loaded from: qc_sdk_20250409.aar:libs/rtk-audioconnect-localplayback-1.0.9.jar:com/realsil/customer/audioconnect/localplayback/LocalPlaybackConstants.class */
public class LocalPlaybackConstants {
    ...
    /* loaded from: qc_sdk_20250409.aar:libs/rtk-audioconnect-localplayback-1.0.9.jar:com/realsil/customer/audioconnect/localplayback/LocalPlaybackConstants$BufferFlag.class */
    public @interface BufferFlag {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: qc_sdk_20250409.aar:libs/rtk-audioconnect-localplayback-1.0.9.jar:com/realsil/customer/audioconnect/localplayback/LocalPlaybackConstants$FormatType.class */
    public @interface FormatType {
    }

    /* loaded from: qc_sdk_20250409.aar:libs/rtk-audioconnect-localplayback-1.0.9.jar:com/realsil/customer/audioconnect/localplayback/LocalPlaybackConstants$Operation.class */
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: qc_sdk_20250409.aar:libs/rtk-audioconnect-localplayback-1.0.9.jar:com/realsil/customer/audioconnect/localplayback/LocalPlaybackConstants$ValidResult.class */
