...
/* loaded from: qc_sdk_20250409.aar:classes.jar:com/realsil/customer/core/bluetooth/connection/le/GattError.class */
public final class GattError {
    ...
    public static String parse(int i) {
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    case EqConstants.CodeIndex.BUILD_IN_EQ_4 /* 128 */:
