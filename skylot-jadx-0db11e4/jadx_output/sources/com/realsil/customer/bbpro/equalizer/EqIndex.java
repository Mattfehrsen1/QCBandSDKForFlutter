...
/* loaded from: qc_sdk_20250409.aar:classes.jar:com/realsil/customer/bbpro/equalizer/EqIndex.class */
public class EqIndex {
    ...
    public static EqIndex b(byte[] bArr) {
        ...
        byte b2 = bArr[1];
        byte b3 = bArr[2];
        int i2 = ((bArr[4] << 8) | (bArr[3] & 255)) & LocalPlaybackTransferEngine.MAX_SEQUENCE_NUMBER;
        byte b4 = bArr[5];
        if (bArr.length < i2 + 5 || (i = i2 - 1) <= 0) {
    ...
    public static EqIndex c(byte[] bArr) {
        ...
        int i2 = ((bArr[5] << 8) | (bArr[4] & 255)) & LocalPlaybackTransferEngine.MAX_SEQUENCE_NUMBER;
        byte b5 = bArr[6];
        if (bArr.length < i2 + 6 || (i = i2 - 1) <= 0) {
            ZLogger.d(String.format(Locale.US, "invalid eqData, packet.length=%d, eqDataLen=0X%04x(%d)", Integer.valueOf(bArr.length), Integer.valueOf(i2), Integer.valueOf(i2)));
            return null;
        }
        byte[] bArr2 = new byte[i];
    ...
    public static EqIndex d(byte[] bArr) {
        ...
        if (eqParameterInfo != null) {
            ...
            audioEq = audioEq;
            AudioEq audioEq2 = new AudioEq(eqParameterInfo.stageNum, eqParameterInfo.globalGain, eqParameterInfo.samplingFreqIndex, eqParameterInfo.accuracy, eqParameterInfo.freq, eqParameterInfo.q, eqParameterInfo.gains, eqParameterInfo.biquadType, null);
        } else {
    ...
    public static EqIndex e(byte[] bArr) {
        ...
        if (v11 != null) {
            audioEq = audioEq;
            AudioEq audioEq2 = new AudioEq(v11.stageNum, v11.globalGain, v11.samplingFreqIndex, v11.accuracy, v11.freq, v11.q, v11.gains, v11.biquadType, null);
        } else {
            ZLogger.d("invalid EqParameterInfo");
            audioEq = audioEq;
            AudioEq audioEq3 = new AudioEq();
    ...
    public static EqIndex f(byte[] bArr) {
        ...
        int i2 = ((bArr[6] << 8) | (bArr[5] & 255)) & LocalPlaybackTransferEngine.MAX_SEQUENCE_NUMBER;
        byte b6 = bArr[7];
        if (bArr.length < i2 + 6 || (i = i2 - 1) <= 0) {
            ZLogger.d(String.format(Locale.US, "invalid eqData, packet.length=%d, eqDataLen=0x%04x(%d)", Integer.valueOf(bArr.length), Integer.valueOf(i2), Integer.valueOf(i2)));
            return null;
    ...
    public static EqIndex g(byte[] bArr) {
        ...
        int i2 = ((bArr[7] << 8) | (bArr[6] & 255)) & LocalPlaybackTransferEngine.MAX_SEQUENCE_NUMBER;
        byte b7 = bArr[8];
        if (bArr.length < i2 + 6 || (i = i2 - 1) <= 0) {
            ZLogger.d(String.format(Locale.US, "invalid eqData, packet.length=%d, eqDataLen=0x%04x(%d)", Integer.valueOf(bArr.length), Integer.valueOf(i2), Integer.valueOf(i2)));
            return null;
