...
class QcBandSdkConst {
  ...
  static const int cmdSetDial = 0x58;

  static const int sportMode = 0x5A;
  static const int getSportMode = 95;
  static const int cmdHrData = 22;
  static const int startSportMode = 0x29;
  
  // Real-time sport data commands (based on Android SDK analysis)
  static const int realTimeSportData = 0x78; // Real-time sport data notifications
  static const int sportDataNotify = 120; // Sport data notification command

  static const int cmdDeviceCalibaration = 115;
  static const cmdReadHrData = 21;
  static const cmdStartHeartRateInt = 105;
  static const cmdGetRealTimeHeartRate = 30;
  static const int getStressData = 56;
